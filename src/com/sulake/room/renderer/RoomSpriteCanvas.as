package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1714:int = 50;
      ...
      private var var_636:RoomObjectCache;
      
      private var var_517:Array;
      
      private var var_632:Array;
      
      private var var_1451:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2623:Number = -1.0E7;
      
      private var var_2625:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_60 = new Sprite();
         this.var_60.name = "canvas";
         this.var_60.mouseEnabled = false;
         this.var_263.addChild(this.var_60);
         this.var_60.mouseEnabled = true;
         this.var_60.doubleClickEnabled = true;
         this.var_60.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_60.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_262 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_636 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_516.x -= param1 - this.var_635;
         this.var_635 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_980 = true;
            if(this.var_134 != null && !this.var_263.contains(this.var_134))
            {
               this.var_263.addChild(this.var_134);
               this.var_60.mask = this.var_134;
            }
         }
         else if(!param1 && this.var_980)
         {
            this.var_980 = false;
            if(this.var_134 != null && this.var_263.contains(this.var_134))
            {
               this.var_263.removeChild(this.var_134);
               this.var_60.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_632.length)
            {
               this.cleanSprite(this.var_632[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_632 = [];
         }
      ...
      {
         this.var_636.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_778 != this.var_2626 || this._ht != this.var_2624)
         {
            _loc9_ = true;
         }
         if(this.var_60.x != this.var_635 || this.var_60.y != this.var_633)
         {
            this.var_60.x = this.var_635;
            this.var_60.y = this.var_633;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_517.sortOn("z",0 | 0);
         if(_loc5_ < this.var_517.length)
         {
            this.var_517.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_517[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2626 = this.var_778;
         this.var_2624 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_636.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_636.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_635;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_633;
                  if(_loc19_ < this.var_778 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_517.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_635;
      ...
      {
         if(param1 < 0 || param1 >= this.var_60.numChildren)
         {
            return null;
         }
         return this.var_60.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_632.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_60.numChildren)
         {
            this.var_60.addChild(_loc3_);
         }
         else
         {
            this.var_60.addChildAt(_loc3_,param2);
         }
         ++this.var_777;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc6_:* = null;
         if(param1 >= this.var_60.numChildren)
         {
            this.createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = this.var_60.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_60.removeChildAt(param1);
                  this.var_632.push(_loc4_);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            _loc5_ = this.var_60.numChildren - 1;
            while(_loc5_ >= param1)
            {
               _loc3_ = this.var_60.getChildAt(_loc5_);
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_517[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_262.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_262.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1201 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1891;
         }
         this.var_1891 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1201;
         return this.var_1891;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_778 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1890,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseClickHits(param1:Number, param2:Number, param3:Boolean, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = this.var_60.getChildAt(_loc14_) as ExtendedSprite;
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2623 || param2 != this.var_2625)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_363.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1451.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
