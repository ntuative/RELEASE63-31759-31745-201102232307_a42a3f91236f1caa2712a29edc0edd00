package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1672 || param2 != this.var_1671)
         {
      ...
      {
         if(this.var_1345 > 255 || bitmapData == null)
         {
            return false;
         }
