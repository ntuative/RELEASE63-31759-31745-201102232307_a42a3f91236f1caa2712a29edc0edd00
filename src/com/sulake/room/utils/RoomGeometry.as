package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_795:Number = 64;
      
      public static const const_1107:Number = 32;
      ...
      private var var_1873:Number = 1.0;
      
      private var var_1872:Number = 1.0;
      
      private var var_1874:Number = 1.0;
      
      private var var_80:Vector3d;
      
      private var var_261:Vector3d;
      
      private var var_2781:Number = -500.0;
      
      private var var_2782:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1193 = new Vector3d();
         this.var_1873 = 1;
         this.var_1872 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1874 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_80.x * this.var_428,this.var_80.y * this.var_427,this.var_80.z * this.var_426);
      }
      ...
      {
         if(this.var_428 != param1 * this.var_1873)
         {
            this.var_428 = param1 * this.var_1873;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_427 != param1 * this.var_1872)
         {
            this.var_427 = param1 * this.var_1872;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_426 != param1 * this.var_1874)
         {
            this.var_426 = param1 * this.var_1874;
            ++this.var_161;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_80.x;
         var _loc3_:Number = this.var_80.y;
         var _loc4_:Number = this.var_80.z;
         this.var_80.assign(param1);
         this.var_80.x /= this.var_428;
         this.var_80.y /= this.var_427;
         this.var_80.z /= this.var_426;
         if(this.var_80.x != _loc2_ || this.var_80.y != _loc3_ || this.var_80.z != _loc4_)
         {
            ++this.var_161;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_511 != null)
         {
            ...
            this.var_511.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_511.add(_loc3_,_loc4_);
            ++this.var_161;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_511 != null)
         {
            ...
            return this.var_511.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1193.assign(_loc22_);
         }
         else
         {
            this.var_1193.assign(_loc17_);
         }
         ++this.var_161;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_80);
         _loc2_.x *= this.var_428;
         _loc2_.y *= this.var_427;
         _loc2_.z *= this.var_426;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1193);
         if(_loc3_ < this.var_2781 || _loc3_ > this.var_2782)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_80);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_428;
            _loc2_.y *= this.var_427;
            _loc2_.z *= this.var_426;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1193);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_80.x * this.var_428,this.var_80.y * this.var_427,this.var_80.z * this.var_426);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_159;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_428,param2.y * this.var_427,param2.z * this.var_426);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_428,param3.y * this.var_427,param3.z * this.var_426);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_428,param4.y * this.var_427,param4.z * this.var_426);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1107;
         }
         else
         {
            this.scale = const_795;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_795;
      }
