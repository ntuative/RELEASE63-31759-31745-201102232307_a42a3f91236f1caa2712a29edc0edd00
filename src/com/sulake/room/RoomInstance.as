package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      {
         if(this.var_1357.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1357.push(param1);
         }
      ...
      {
         if(this.var_1358.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_600.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_600[_loc2_]);
