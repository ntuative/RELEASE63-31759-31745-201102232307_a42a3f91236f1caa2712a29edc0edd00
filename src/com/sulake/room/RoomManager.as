package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_726:int = -1;
      
      public static const const_1595:int = 0;
      ...
      private var var_2806:IRoomContentLoader;
      
      private var var_609:IRoomObjectFactory = null;
      
      private var var_497:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1140:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_608 = [];
         this.var_600 = [];
         events.addEventListener(RoomContentLoadedEvent.const_377,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_609 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_609 == null || this.var_497 == null)
         {
            return;
         }
         this._state = const_1507;
         if(this.var_1140 != null)
         {
            _loc1_ = this.var_1140;
            this.var_1140 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_608.indexOf(_loc5_) < 0)
            {
               this.var_52.loadObjectContent(_loc5_,events);
               this.var_608.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_600.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_600.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_600[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_497.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_497.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_609.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_609 != null)
         {
            return this.var_609.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_52.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_608.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_608.splice(_loc2_,1);
            }
            if(this.var_608.length == 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_52 == null || this.var_497 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_497.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_497.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_609.createRoomObjectLogic(_loc18_);
