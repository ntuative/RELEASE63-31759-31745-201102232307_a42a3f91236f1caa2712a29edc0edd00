package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_320:IRoomObjectController;
      ...
      {
         if(this.var_320 == param1)
         {
            return;
         }
         if(this.var_320 != null)
         {
            this.var_320.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_320 = param1;
            this.var_320.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_320 != null)
            {
               this.var_320.setLocation(param1.loc);
               this.var_320.setDirection(param1.dir);
            }
         }
      }
   }
