package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_320:IRoomObject;
      
      private var var_740:IGraphicAssetCollection;
      
      protected var var_440:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_196 != null)
         {
            ...
            {
               _loc1_ = this.var_196[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_740.removeReference();
         }
         this.var_740 = param1;
         if(this.var_740 != null)
         {
            this.var_740.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_196.length > param1)
         {
            _loc2_ = this.var_196[this.var_196.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
