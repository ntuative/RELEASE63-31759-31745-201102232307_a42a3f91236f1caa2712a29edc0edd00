package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_954:int = 60;
      
      private static const const_956:int = 3600;
      
      private static const const_953:int = 86400;
      
      private static const const_955:int = 31536000;
      ...
      {
         if(param1 < 2 * const_954)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_956)
         {
            return Math.round(param1 / const_954) + " mins ago";
         }
         if(param1 < 2 * const_953)
         {
            return Math.round(param1 / const_956) + " hours ago";
         }
         if(param1 < 2 * const_955)
         {
            return Math.round(param1 / const_953) + " days ago";
         }
         return Math.round(param1 / const_955) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1175.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1175.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1135,this._data.userId),this._callerFrame,this.var_1174,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1174,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1330),this._callerFrame,this.var_1174,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1330),this._callerFrame,this.var_1174,false,true);
      }
