package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1018:int = 3;
      
      public static const const_699:int = 4;
      
      public static const const_1135:int = 5;
      
      public static const const_1557:int = 6;
      
      public static const const_1503:int = 7;
      ...
      {
         var _loc2_:Dictionary = this.var_1759[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1759[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
