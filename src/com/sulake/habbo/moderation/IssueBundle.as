package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_757:IssueMessageData = null;
      
      private var var_758:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2454 = param2.pickerUserId;
         this.var_2513 = param2.pickerUserName;
         this.var_1271 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1150 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1149;
         }
         if(this.var_757 == null || param1.timeStamp < this.var_757.timeStamp)
         {
            this.var_757 = param1;
         }
         if(this.var_758 == null || param1.priority > this.var_758.timeStamp)
         {
            this.var_758 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1150 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1149;
            }
            if(this.var_757 == _loc2_)
            {
               this.var_757 = null;
            }
            if(this.var_758 == _loc2_)
            {
               this.var_758 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_758;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_757;
         if(_loc2_ == null)
         {
