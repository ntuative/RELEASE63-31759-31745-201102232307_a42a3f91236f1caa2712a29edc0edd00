package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_596:int = 20;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1828 = this.var_546.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         {
            this.var_58.destroyListItems();
            return;
         }
         param1.sortOn("prioritySum",0 | 0);
         var _loc4_:int = this.var_58.numListItems;
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1828.clone() as IWindowContainer;
         ...
         else if(_loc4_ > _loc5_)
         {
            ...
            {
               _loc9_ = this.var_58.removeListItemAt(0);
               _loc9_.dispose();
               _loc2_++;
            }
         }
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1828 == null)
            {
               return;
            }
            _loc3_ = this.var_58.getListItemAt(_loc2_ - 1) as IWindowContainer;
            if(_loc3_ == null)
            {
               return;
            }
            _loc3_.width = this.var_58.width;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_546.assets.getAssetByName(_loc12_) as BitmapDataAsset;
            ...
            {
               _loc6_.id = _loc7_.id;
               _loc6_.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_7);
               _loc6_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_7);
            }
