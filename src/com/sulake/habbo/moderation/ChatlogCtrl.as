package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_851:Array = [];
      
      private static var var_1604:int = 1000;
      
      private static var var_852:Array = [];
      ...
      private var var_1605:IMessageComposer;
      ...
      {
         this.var_684 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_683 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1605);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_851.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_683.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_851.length < var_1604)
         {
            ...
            param1.width = this.var_683.width;
            param1.height = this.var_683.height;
            var_851.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_852.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1602[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1297.getValue(param2.chatterName))
            {
               this.var_1297.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1297.getValue(_loc2_);
      ...
      {
         if(param1.type != WindowEvent.const_48 || param2 != this._frame)
         {
            return;
         }
         this.var_449.reset();
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1296)
         {
