package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1838:int = 200;
      ...
      {
         this.var_765 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
         ...
         this.var_58 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1557;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_58);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_765.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_954.length < var_1838)
         {
            ...
            param1.width = this.var_765.width;
            param1.height = this.var_765.height;
            var_954.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_58.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_58.scrollableRegion.height > this.var_58.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_58.width += 17;
            }
         }
         else if(_loc4_)
         {
