package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1989:String = "my_issues";
      
      private const const_1988:String = "open_issues";
      
      private const const_1990:String = "picked_issues";
      
      private const const_2008:String = "closed_issues";
      ...
      private var var_1711:IIssueBrowserView;
      
      private var var_1709:IIssueBrowserView;
      
      private var var_1710:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_341.view.width = this.var_250.container.width;
         this.var_341.view.height = this.var_250.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1989:
               if(this.var_1711 == null)
               {
                  this.var_1711 = new MyIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1711;
            case this.const_1988:
               if(this.var_1709 == null)
               {
                  this.var_1709 = new OpenIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1709;
            case this.const_1990:
               if(this.var_1710 == null)
               {
                  this.var_1710 = new PickedIssuesView(this.issueManager,this,this.var_250.container);
               }
