package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1341:int = 1;
      ...
      {
         return this.getUserDataByType(param1,const_1341);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_974.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_974.remove(param1);
         this.var_974.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1342);
      }
