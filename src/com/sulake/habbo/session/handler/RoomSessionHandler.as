package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1161:String = "RS_CONNECTED";
      
      public static const const_1117:String = "RS_READY";
      
      public static const const_840:String = "RS_DISCONNECTED";
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1161);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1117);
         }
      }
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         if(_loc5_ == null || _loc5_.length == 0)
         {
            if(listener)
            {
               listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_840);
            }
         }
         else if(listener && false)
         {
