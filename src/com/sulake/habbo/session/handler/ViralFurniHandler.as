package com.sulake.habbo.session.handler
{
   ...
   public class ViralFurniHandler extends BaseHandler
   {
      ...
      private function onViralFurniStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_436,_loc6_);
      ...
      private function onViralGiftReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_539,_loc4_);
