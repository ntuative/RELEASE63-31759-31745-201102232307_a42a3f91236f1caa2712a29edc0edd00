package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1994:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_221 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1399));
         this.var_1400.add(this.var_1399,getTimer());
         ++this.var_1399;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1400.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1994)
            {
