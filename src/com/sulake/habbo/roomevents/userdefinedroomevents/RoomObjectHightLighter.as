package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_77.roomEngine.getRoomObject(this.var_77.roomId,this.var_77.roomCategory,param1,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
