package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_1008:SliderWindowController;
      
      private var var_1051:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1008.getValue());
         _loc2_.push(this.var_1051.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_77 = param2;
         this.var_1008 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1008.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1008.setValue(1);
         this.var_1051 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1051.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1051.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1008.setValue(_loc3_);
         this.var_1051.setValue(_loc4_);
      }
      ...
      private function onSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_77.localization.registerParameter("wiredfurni.params.setpoints","points","" + _loc4_);
            }
         }
      }
      ...
      private function onCounterSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = _loc2_.getValue();
               _loc4_ = int(_loc3_);
               this.var_77.localization.registerParameter("wiredfurni.params.settimesingame","times","" + _loc4_);
            }
         }
      }
   }
