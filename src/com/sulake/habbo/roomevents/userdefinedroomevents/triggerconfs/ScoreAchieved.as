package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class ScoreAchieved implements TriggerConf
   {
      ...
      {
         return TriggerConfCodes.var_1939;
      }
      ...
      {
         this.var_77 = param2;
         this.var_1008 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1000,1);
      ...
      private function onSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_77.localization.registerParameter("wiredfurni.params.setscore","points","" + _loc4_);
            }
         }
      }
   }
