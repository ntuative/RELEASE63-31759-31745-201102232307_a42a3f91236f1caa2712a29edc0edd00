package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1200:SliderWindowController;
      
      private var var_1199:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1200.getValue());
         _loc2_.push(this.var_1199.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_77 = param2;
         this.var_1200 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1200.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1200.setValue(1);
         this.var_1199 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1199.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1199.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1200.setValue(_loc3_);
         this.var_1199.setValue(_loc4_);
      }
