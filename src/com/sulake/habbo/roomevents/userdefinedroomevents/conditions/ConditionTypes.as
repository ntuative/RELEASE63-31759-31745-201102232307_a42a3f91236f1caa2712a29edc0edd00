package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_126.push(new ActorIsOnFurni());
         this.var_126.push(new FurnisHaveAvatars());
         this.var_126.push(new StatesMatch());
         this.var_126.push(new TimeElapsedMore());
         this.var_126.push(new TimeElapsedLess());
         this.var_126.push(new UserCountIn());
         this.var_126.push(new ActorIsInTeam());
         this.var_126.push(new HasStackedFurnis());
         this.var_126.push(new StuffTypeMatches());
      }
