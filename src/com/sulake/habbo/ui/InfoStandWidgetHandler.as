package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_147,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_164,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_99,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_147,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_164,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_99,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_571.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_571.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_381);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_852);
         _loc1_.push(RoomWidgetUserActionMessage.const_459);
         _loc1_.push(RoomWidgetUserActionMessage.const_761);
         _loc1_.push(RoomWidgetUserActionMessage.const_807);
         _loc1_.push(RoomWidgetUserActionMessage.const_691);
         _loc1_.push(RoomWidgetUserActionMessage.const_844);
         _loc1_.push(RoomWidgetUserActionMessage.const_730);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_301);
         _loc1_.push(RoomWidgetFurniActionMessage.const_788);
         _loc1_.push(RoomWidgetFurniActionMessage.const_758);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_632);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_613);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_847);
         _loc1_.push(RoomWidgetUserActionMessage.const_524);
         _loc1_.push(RoomWidgetUserActionMessage.const_877);
         _loc1_.push(RoomWidgetUserActionMessage.const_569);
         _loc1_.push(RoomWidgetUserActionMessage.const_1520);
         _loc1_.push(RoomWidgetPetCommandMessage.const_456);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_395 || param1.type == RoomWidgetUserActionMessage.const_526 || param1.type == RoomWidgetUserActionMessage.const_569)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_381:
            ...
            case RoomWidgetUserActionMessage.const_799:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1002,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_892:
               ...
               break;
            case RoomWidgetUserActionMessage.const_852:
            ...
            case RoomWidgetUserActionMessage.const_761:
               ...
               break;
            case RoomWidgetUserActionMessage.const_807:
            ...
            case RoomWidgetUserActionMessage.const_691:
               ...
               break;
            case RoomWidgetUserActionMessage.const_844:
            ...
            case RoomWidgetUserActionMessage.const_395:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_632:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_613:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_847:
            ...
            case RoomWidgetUserActionMessage.const_524:
               ...
               break;
            case RoomWidgetUserActionMessage.const_877:
            ...
            case RoomWidgetPetCommandMessage.const_637:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_456:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_323);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_400);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1192);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1086);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_177)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_727)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_430);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_120)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_133)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_794);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_992;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1217;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1554);
               }
               else
               {
               ...
               _loc19_ = _loc11_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_55,_loc19_);
               if(_loc20_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_71,RoomSessionUserGivableBadgesEvent.const_71];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_71:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_71:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_571.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_571.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_794);
