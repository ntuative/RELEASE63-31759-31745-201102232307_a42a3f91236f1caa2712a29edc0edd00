package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_748,RoomWidgetViralFurniMessage.const_846,RoomWidgetViralFurniMessage.const_161];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_748:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_544);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_846:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_161:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_436,RoomSessionViralFurniStatusEvent.const_539];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_436:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_849);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_539:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
