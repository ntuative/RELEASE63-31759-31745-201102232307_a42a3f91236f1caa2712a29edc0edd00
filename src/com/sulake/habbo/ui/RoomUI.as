package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1030:IRoomWidgetFactory;
      
      private var var_404:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_486:IAvatarRenderManager;
      ...
      private var var_1031:IHabboHelp;
      ...
      {
         this.var_1274 = RoomDesktop.const_478;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1030.release(new IIDHabboRoomWidget());
            this.var_1030 = null;
         }
         ...
         {
            this.var_486.release(new IIDAvatarRenderManager());
            this.var_486 = null;
         }
         ...
         {
            this.var_1031.release(new IIDHabboHelp());
            this.var_1031 = null;
         }
         ...
         {
            this.var_828.release(new IIDHabboModeration());
            this.var_828 = null;
         }
         ...
         if(this.var_1029)
         {
            this.var_1029.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1029 = null;
         }
         this.var_1564 = null;
         ...
         if(this.var_284)
         {
            ...
            {
               _loc1_ = this.var_284.getKey(0) as String;
               _loc2_ = this.var_284.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1030 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_486 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1564 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_285 != null && this.var_285.events != null)
         {
            this.var_285.events.addEventListener(AdEvent.const_463,this.adEventHandler);
            this.var_285.events.addEventListener(AdEvent.const_530,this.adEventHandler);
            this.var_285.events.addEventListener(AdEvent.const_427,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1031 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_828 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_828);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_186,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_437,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_575,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_495,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_436,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_539,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_878,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1038,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1151,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_714,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_623,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_191,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_839,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_804,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_578,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_129,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_125,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_149,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.include,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_132,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_465,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_137,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserNotificationEvent.const_110,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.ZOOM));
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.MEMENU));
                  this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_714:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_623:
      ...
      {
         this.var_1029 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_689,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_901,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_692,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_536,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_454,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_313,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_480,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_454 || param1.type == RoomEngineEvent.const_536)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_901:
               _loc5_ = false;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_739);
               ...
               if(this.var_1274 != RoomDesktop.const_478)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_278,this.var_1274);
               }
               if(this.var_285 != null)
               {
                  this.var_285.showRoomAd();
               }
               break;
            case RoomEngineEvent.const_692:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1030;
         _loc3_.sessionDataManager = this.var_404;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_486;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_181;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1564;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_285;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1031;
         _loc3_.moderation = this.var_828;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_598;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1029;
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_284.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_278);
            if(_loc3_ != RoomDesktop.const_478)
            {
               this.var_1274 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
      ...
      {
         return this.var_284.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_284.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
