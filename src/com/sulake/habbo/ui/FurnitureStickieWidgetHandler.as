package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_617,RoomWidgetStickieSendUpdateMessage.const_642,RoomWidgetStickieSendUpdateMessage.const_433];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_617:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1133);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_433:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_642:
