package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_440,RoomWidgetPollMessage.const_668];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_668:
               ...
               break;
            case RoomWidgetPollMessage.const_440:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionPollEvent.include);
         _loc1_.push(RoomSessionPollEvent.const_149);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_132:
               ...
               break;
            case RoomSessionPollEvent.include:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.include);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_149:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_149);
