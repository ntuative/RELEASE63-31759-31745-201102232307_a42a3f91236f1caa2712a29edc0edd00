package com.sulake.habbo.ui
{
   ...
   public class UserNotificationWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserNotificationMessage.const_1145);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionUserNotificationEvent.const_110];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserNotificationEvent.const_110:
               _loc2_ = param1 as RoomSessionUserNotificationEvent;
               _loc3_ = new RoomWidgetUserNotificationEvent(RoomWidgetUserNotificationEvent.const_513);
