package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_865,RoomWidgetEcotronBoxOpenMessage.const_805,RoomWidgetEcotronBoxOpenedMessage.const_1634];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_865:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc8_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_69,_loc2_.id,_loc6_,_loc7_);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_805:
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_88,0,this._name,false,param2);
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_290:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_88,0,this._name,false,_loc3_.data);
