   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_803,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_639,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_181 != null)
            {
               this.var_181.events.removeEventListener(HabboToolbarEvent.const_66,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_499,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_803,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_639,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_499,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1355)
            {
               _loc3_ = this._container.sessionDataManager.gender;
               _loc4_ = this._container.avatarRenderManager.createAvatarImage(_loc2_,AvatarScaleType.const_55,_loc3_,this);
               if(_loc4_ != null)
               {
               ...
               this.var_1685 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1685;
            }
         }
         if(this.var_181 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1127,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_798);
         _loc1_.push(RoomWidgetDanceMessage.const_772);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_863);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_725);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_728);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_656);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_759);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_335);
         _loc1_.push(RoomWidgetStopEffectMessage.const_701);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1541);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1044);
         _loc1_.push(RoomWidgetToolbarMessage.const_685);
         _loc1_.push(RoomWidgetToolbarMessage.const_854);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_404);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1600);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1036);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_771);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_636);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_899);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1403);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_620);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_624);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_841);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_636:
               ...
               break;
            case RoomWidgetWaveMessage.const_798:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_772:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_863:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_725:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_728:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_335:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1097)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_197,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_759:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1013:
                        this._catalog.openCatalogPage(CatalogPageName.const_1571,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1098:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_312);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1491:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1367:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_656:
            case RoomWidgetStopEffectMessage.const_701:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1044:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_771:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_685:
               ...
               if(this.var_181)
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_854:
               ...
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_522,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_404:
               ...
               if(this._container)
               {
                  ...
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_vip_outfits",HabboClubLevelEnum.const_41))
                  {
                     _loc21_ = 0;
                  }
            ...
            case RoomWidgetGetSettingsMessage.const_899:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_390,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_620:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_390,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_624:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_390,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_841:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_581));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_358:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_779));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_900));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_499:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_518));
         }
      }
