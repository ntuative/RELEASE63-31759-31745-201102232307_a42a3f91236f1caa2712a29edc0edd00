package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_544[this.var_989]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_544[this.var_989] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_989));
