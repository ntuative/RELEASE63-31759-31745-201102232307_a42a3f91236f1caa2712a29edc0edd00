package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1943:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_906 = param1.gender;
         this.var_774 = param1.online;
         this.var_1662 = param1.followingAllowed && param1.online;
         this.var_595 = param1.figure;
         this.var_1902 = param1.motto;
         this.var_1869 = param1.lastAccess;
         this.var_1284 = param1.categoryId;
         this.var_1871 = param1.realName;
