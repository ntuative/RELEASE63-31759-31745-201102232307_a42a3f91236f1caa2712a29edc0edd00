package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_364:int = 100;
      
      public static const const_1010:int = 0;
      ...
      {
         if(this.var_813 >= this.getPageCount())
         {
            this.var_813 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_205.length / const_364);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_813 * const_364;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_813 + 1) * const_364,this.var_205.length);
      }
