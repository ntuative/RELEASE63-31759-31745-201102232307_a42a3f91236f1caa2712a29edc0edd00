package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_429:IFriendRequestsDeps;
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            if(!param1 || _loc3_.state != FriendRequest.const_166)
            {
               _loc2_.push(_loc3_);
            }
         }
         for each(_loc4_ in _loc2_)
         {
            ...
            if(this.var_429.view != null)
            {
               this.var_429.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         this.refreshShading();
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_1114;
         this.var_429.view.refreshRequestEntry(_loc2_);
      }
      ...
      {
         this._requests.push(param1);
         this.var_429.view.addRequest(param1);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            this.var_429.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_166)
            {
               _loc1_++;
            }
         }
