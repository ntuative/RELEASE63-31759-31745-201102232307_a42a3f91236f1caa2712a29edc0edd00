package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_193 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_193.length);
         this.var_840 = ITextFieldWindow(param1.findChildByName("message_input"));
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_193)
         {
