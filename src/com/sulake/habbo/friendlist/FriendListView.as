package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1706:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1429:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1429 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_899 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_230 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1429.prepare(this.var_899);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1204,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1034,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_626,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_641,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_626,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_641,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1428 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1428.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1841 == -1 ? 0 : int(this.var_16.height - this.var_1841);
         var _loc4_:int = this.var_1839 == -1 ? 0 : int(this.var_16.width - this.var_1839);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_230.y = Util.getLowestPoint(this.var_16.content);
         this.var_230.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1088,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_626,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1204,false);
         ...
         this.var_1841 = this.var_16.height;
         this.var_1839 = this.var_16.width;
