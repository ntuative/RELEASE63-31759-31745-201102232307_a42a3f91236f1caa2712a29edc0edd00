package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_128:IHabboMessenger;
      
      private var var_173:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1037:IAvatarRenderManager;
      
      private var var_751:ISessionDataManager;
      
      private var var_2483:FriendListLookAndFeel;
      
      private var var_437:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1803:OpenedToWebPopup;
      ...
      private var var_1802:AvatarSearchResults;
      
      private var var_181:IHabboToolbar;
      
      private var var_879:IHabboNotifications;
      
      private var var_614:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2483 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1802 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_614.stop();
            this.var_614.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_614 = null;
         }
         ...
         if(this.var_128)
         {
            this.var_128.release(new IIDHabboMessenger());
            this.var_128 = null;
         }
         if(this.var_173)
         {
         ...
         if(this.var_1037)
         {
            this.var_1037.release(new IIDAvatarRenderManager());
            this.var_1037 = null;
         }
         if(this.var_879)
         {
         ...
         if(this.var_751)
         {
            this.var_751.release(new IIDSessionDataManager());
            this.var_751 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1803 = new OpenedToWebPopup(this);
         }
         this.var_1803.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_95.findFriend(param1);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.FRIENDLIST);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1037.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_173.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboCatalogCom_productViewWidget";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_173.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_128 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1037 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_879 = param2 as IHabboNotifications;
      ...
      {
         this.var_751 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1010,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_383,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_95.addFriend(new Friend(_loc4_));
         }
         this.var_437 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_614)
         {
            this.var_614 = new Timer(120000);
            this.var_614.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_614.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.FRIENDLIST));
         this.var_181.events.addEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
         if(this.var_95.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_383);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_437.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_437.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_437.findTab(FriendListTab.const_96);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1802.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_95.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_95.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_437.findTab(FriendListTab.const_96);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_751 || !this.var_348)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_751.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_348.vipLimit;
         }
         else if(this.var_751.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_95.getAllFriends();
