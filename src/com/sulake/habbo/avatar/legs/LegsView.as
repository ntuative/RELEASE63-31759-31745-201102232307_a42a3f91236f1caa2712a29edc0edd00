   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_262,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_259,_windowManager,_assetLibrary);
         }
         else
         {
