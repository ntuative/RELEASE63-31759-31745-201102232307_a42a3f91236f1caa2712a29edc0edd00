package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1284:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1286:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1111:AvatarEditorHandler;
      ...
      private var var_904:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_485)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_185)
         {
            ...
            this.var_594["null"] = new FigureData(this);
            this.var_594["null"] = new FigureData(this);
            _loc2_ = this.var_594["null"];
            _loc3_ = this.var_594["null"];
            _loc2_.loadAvatarData(const_1284,FigureData.const_74);
            _loc3_.loadAvatarData(const_1286,FigureData.FEMALE);
            this.var_95 = new Map();
            this.var_485 = new Map();
            this.var_95.add(AvatarEditorFigureCategory.const_763,new BodyModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_218,new TorsoModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_721,new LegsModel(this));
            ...
            this.var_485.add(AvatarEditorSideCategory.const_105,new WardrobeModel(this));
            this.var_485.add(AvatarEditorSideCategory.const_441,new ClubPromoModel(this));
            this.var_185 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_594[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_904.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_904.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_763);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_485.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_486 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_904 = this.var_486.getFigureData(AvatarType.const_121);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1111 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_594[this.var_906];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1376 != null)
         {
            ...
            this.var_1376.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1726;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1110 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1285)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1478.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_486.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_486.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1220.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1482)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1110 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1220.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1110 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_485.getValue(AvatarEditorSideCategory.const_105);
      }
