package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1220:IWindowContainer;
      
      public static var var_1478:IWindowContainer;
      
      public static var var_1943:int = 6710886;
      ...
      private var var_458:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_459:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1028 = [];
         this.var_1272 = [AvatarEditorFigureCategory.const_763,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_218,AvatarEditorFigureCategory.const_721,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1220 == null)
         {
            ...
            var_1220 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1478 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1478 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_384 = new Timer(1000);
         this.var_384.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1272;
         }
         for each(_loc6_ in param4)
         {
            this.var_1028.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_384.stop();
            this.var_384.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_384 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1272);
         }
         if(param1.length != this.var_1028.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1028.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2127 = this.canChangeOutfit();
            this.var_384.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_458 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_458.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_458.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1028.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_458.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_458.numSelectables)
               {
                  this.var_458.getSelectableAt(_loc6_).x = this.var_458.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1272;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1561 == AvatarEditorSideCategory.const_105 || this.var_2126))
         {
      ...
      {
         if(this.var_1561 == AvatarEditorSideCategory.const_105)
         {
            this.var_2126 = false;
            this.setSideContent(AvatarEditorSideCategory.const_766);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_766:
               break;
            case AvatarEditorSideCategory.const_441:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_441);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_355 = param1;
         this.var_458.setSelected(this.var_458.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_459)
         {
            ...
            this.var_459 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_459.procedure = this.stripClubDialogEventProc;
            this.var_459.center();
         }
         else
         {
