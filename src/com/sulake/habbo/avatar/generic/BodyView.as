package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_608:String = "tab_boy";
      
      private const const_607:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_66.controller.gender)
         {
            case FigureData.const_74:
               activateTab(this.const_608);
               inactivateTab(this.const_607);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_607);
               inactivateTab(this.const_608);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_608:
                  var_66.controller.gender = FigureData.const_74;
