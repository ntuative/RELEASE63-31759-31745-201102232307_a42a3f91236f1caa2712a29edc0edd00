   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_213,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_183,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_66,FigureData.const_228,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_136 == "")
         {
            var_66.switchCategory(FigureData.const_183);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_183);
                  break;
