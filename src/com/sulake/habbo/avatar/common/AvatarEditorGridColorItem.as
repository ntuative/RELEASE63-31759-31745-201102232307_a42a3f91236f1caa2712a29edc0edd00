package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_888:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_558.width,this.var_558.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_558,this.var_558.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_842.width,this.var_842.height,true,0);
            _loc5_ = this.var_842.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_888.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_843.width,this.var_843.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_843,this.var_843.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_888)
            {
               switch(this.var_888.clubLevel)
               {
                  case HabboClubLevelEnum.const_51:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_40:
                     _loc4_.style = HabboIconType.const_826;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc4_.style = HabboIconType.const_665;
                     _loc4_.visible = true;
               }
            }
            else
