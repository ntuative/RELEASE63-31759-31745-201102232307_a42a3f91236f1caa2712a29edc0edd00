package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1534 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2093 = parseInt(param1.@precedence);
         this.var_2094 = String(param1.@activepartset);
         this.var_2090 = String(param1.@assetpartdefinition);
         this.var_2088 = String(param1.@lay);
         this.var_724 = String(param1.@geometrytype);
         this.var_2092 = Boolean(parseInt(param1.@main));
         this.var_2089 = Boolean(parseInt(param1.@const_581));
         this.var_2091 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboCatalogCom_productViewWidget"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            {
               this.var_1534[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_126[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_666.add(param1,new Map());
         }
         var _loc4_:Map = this.var_666.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_666.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1534[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2095;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_126[param1];
         if(_loc2_ != null)
         {
