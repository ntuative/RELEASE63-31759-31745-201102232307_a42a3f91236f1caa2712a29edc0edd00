package com.sulake.habbo.avatar.actions
{
   public class ActionType
   {
      ...
      public function ActionType(param1:XML)
      {
         ...
         this.var_182 = parseInt(param1.@value);
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            this._prevents = _loc2_.split(",");
         }
         this._preventHeadTurn = String(param1.@preventheadturn) == "HabboCatalogCom_productViewWidget";
         ...
         {
            this.var_1536 = _loc3_ == "HabboCatalogCom_productViewWidget";
         }
      }
