package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_344 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function method_1() : void
      {
         ...
         if(this.var_595 && this.var_1377)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_83,this.var_906,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_790));
         ...
         if(this.var_344)
         {
            if(this.var_344.bitmap)
            {
               this.var_344.bitmap.dispose();
            }
            this.var_344.bitmap = new BitmapData(this.var_344.width,this.var_344.height,true,0);
            _loc7_ = (this.var_344.width - _loc1_.width) / 2;
            _loc8_ = (this.var_344.height - _loc1_.height) / 2;
            this.var_344.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_595 = this._controller.figureData.getFigureString();
               this.var_906 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1731,this);
               this.method_1();
               break;
            case "get_button":
               if(this.var_595)
               {
                  this._controller.loadAvatarInEditor(this.var_595,this.var_906,this._controller.clubMemberLevel);
               }
         }
      }
