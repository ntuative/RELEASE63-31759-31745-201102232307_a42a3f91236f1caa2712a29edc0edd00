package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_595:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_595 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_595.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1406 = this.var_1203;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_50)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1406);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_627);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_595,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1406 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_627);
                  _loc20_ = this.var_88;
                  _loc21_ = 1;
                  switch(this.var_88)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_627);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_595,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_83)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_627);
                  _loc21_ = this.var_88;
                  _loc22_ = 1;
                  switch(this.var_88)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_336:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1453:
                  case AvatarAction.const_1610:
                  case AvatarAction.const_1475:
                  case AvatarAction.const_1169:
                  case AvatarAction.const_1157:
                  case AvatarAction.const_1418:
                  case AvatarAction.const_1629:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1404 = this._structure.sortActions(this.var_314);
         ...
         {
            this.var_666 = this._structure.getCanvasOffsets(this.var_1404,this._scale,this.var_88);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1404)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_317)
               {
                  this.var_932 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1203 = _loc4_.id;
                     this.var_1614 = _loc4_.breed;
                     break;
                  }
               }
            }
