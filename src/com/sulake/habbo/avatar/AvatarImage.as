package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1312:String = "Default";
      
      private static const const_1313:int = 2;
      
      private static const const_1311:String = AvatarSetType.const_34;
      ...
      protected var var_764:Boolean;
      
      protected var var_666:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_248:AvatarImageCache;
      
      protected var var_595:AvatarFigureContainer;
      ...
      private var var_2594:String = null;
      
      private var var_2596:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1311,const_1313);
         this.var_314 = new Array();
         this.var_933 = new ActiveActionData(AvatarAction.const_379);
         this.var_933.definition = this._structure.getActionDefinition(const_1312);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_764)
         {
            ...
            if(this.var_769)
            {
               for each(_loc2_ in this.var_769)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_595,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1804;
         if(param2 < AvatarDirectionAngle.const_1201)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_627,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_260.length == 1 && this.var_88 == this.var_1987)
         {
            return this.var_88 + this.var_508 + this.var_627 % 4;
         }
         if(this.var_260.length == 2)
         {
            for each(_loc1_ in this.var_260)
            {
               ...
               {
                  return this.var_88 + this.var_508 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_627 % 11;
                  return this.var_88 + "_" + this.var_1987 + this.var_508 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2595 || param2 != this.var_2594 || param1 != this.var_2596)
         {
            this.var_2595 = param3;
            this.var_2594 = param2;
            this.var_2596 = param1;
            this.var_1845 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1235 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1235)
            {
               this.var_44.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_269.definition.geometryType,this.var_88);
         this.var_44.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_627);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_627);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_314.push(new ActiveActionData(param1,param2,this.var_627));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_269 = this.var_933;
         this.var_269.definition = this.var_933.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_508 = "";
         this.var_260 = this._structure.sortActions(this.var_314);
         if(this.var_260 == null)
         {
            this.var_666 = new Array(0,0,0);
            if(this.var_1432 != "")
            {
               _loc1_ = true;
               this.var_1432 = "";
         ...
         {
            this.var_666 = this._structure.getCanvasOffsets(this.var_260,this._scale,this.var_88);
            for each(_loc4_ in this.var_260)
            {
               this.var_508 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_274)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1433 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1432 != this.var_508)
            {
               _loc1_ = true;
               this.var_1432 = this.var_508;
            }
         }
         this.var_1405 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_260)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_932 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_196 = this.var_196.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1804 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_317 || _loc1_.actionType == AvatarAction.const_214 || _loc1_.actionType == AvatarAction.const_333)
               {
                  this.var_932 = true;
               }
            }
