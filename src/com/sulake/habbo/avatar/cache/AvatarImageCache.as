package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1696:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1321:IAvatarImage;
      ...
      private var var_2342:ByteArray;
      
      private var var_2343:ImageData;
      
      private var var_873:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_724 == GeometryType.const_1063 && param1 == GeometryType.const_988 || this.var_724 == GeometryType.const_988 && param1 == GeometryType.const_1063)
         {
            this.var_724 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_340.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_837)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_561)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1321.getFigure(),_loc5_,this.var_724,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_382 == null)
         {
            ...
            this.var_382 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_340);
            if(this.var_382 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_724);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2341 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1406[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_760 || _loc10_ == AvatarAction.const_333;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1365 = this.var_109.bodyPartId;
               this.var_176 = this.var_109.partType;
               this.var_1699 = this.var_109.partId;
               ...
               this.var_1364 = this._scale + "_" + this.var_109.action.assetPartDefinition + "_" + this.var_176 + "_" + this.var_1699 + "_" + _loc5_ + "_" + this._frame;
               this.var_407 = this._assets.getAssetByName(this.var_1364) as BitmapDataAsset;
               if(this.var_407 == null)
               {
                  this.var_1364 = this._scale + "_std_" + this.var_176 + "_" + this.var_1699 + "_" + _loc5_ + "_0";
                  this.var_407 = this._assets.getAssetByName(this.var_1364) as BitmapDataAsset;
               }
               if(!(!this.var_407 || !this.var_407.content))
               {
                  if(this.var_109.paletteMapId > -1)
                  {
                     this.var_873 = this._structure.renderManager.paletteManager.getPalette(this.var_109.paletteMapId);
                     if(this.var_873 != null)
                     {
                        this.var_897 = this.var_407.content as BitmapData;
                        this.var_175 = new BitmapData(this.var_897.width,this.var_897.height);
                        this.var_2342 = this.var_873.colorize(this.var_897.getPixels(this.var_897.rect));
                        this.var_175.setPixels(this.var_175.rect,this.var_2342);
                     }
                     else
                     {
                        this.var_175 = (this.var_407.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1365 == AvatarBodyPartType.const_218 || this.var_1365 == AvatarBodyPartType.const_1444 || this.var_1365 == AvatarBodyPartType.const_1374) && this.var_109.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_175.colorTransform(this.var_175.rect,this.var_109.color.colorTransform);
                  }
                  if(this.var_109.isBlendable)
                  {
                     this.var_175.colorTransform(this.var_175.rect,this.var_109.blendTransform);
                  }
                  this.var_895 = this.var_407.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_55)
                     {
                  ...
                  this.var_2343 = new ImageData(this.var_175,this.var_895,_loc7_);
                  this.var_896.push(this.var_2343);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_896,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2341.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_55)
            {
         ...
         _loc8_ = this.var_896.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_896.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
