package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2194:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1876 = parseInt(param2.@ink);
         this.var_2193 = String(param2.@member);
         this.var_2192 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1295 = [];
         this.var_1294 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1295[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1294[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1294.length)
         {
            return this.var_1294[param1];
         }
         return 0;
      }
