package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_.getSelectedItemIndex(FurniModel.const_49) == -1)
         {
            _loc4_.toggleItemSelection(FurniModel.const_49,0);
         }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_732);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.method_1();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_312);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_397);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_277);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_405);
         var _loc4_:FurniModel = this._inventory.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.method_1();
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_405))
         {
