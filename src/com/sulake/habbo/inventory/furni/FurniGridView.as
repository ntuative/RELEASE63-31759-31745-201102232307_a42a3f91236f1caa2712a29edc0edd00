   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_66.toggleItemSelection(this._category,this.var_470.getGridItemIndex(param1.window));
            this.var_560 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_560 != null && this.var_560 == param2 && !this.var_66.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_316)
         {
