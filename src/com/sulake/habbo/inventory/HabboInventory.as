package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1020:IRoomSession;
      ...
      private const const_1978:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_277));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_732));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_312));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_397));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_131));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_405) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_404 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_181)
         {
            return;
         }
         ...
         this.var_49.add(InventoryCategory.const_405,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_312,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_732,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_404);
         this.var_49.add(InventoryCategory.const_397,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_277,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_131,_loc8_);
         this.var_185 = true;
         if(this.var_2250)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_876.indexOf(param1) == -1)
            {
               this.var_876.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_876.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_876.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_876.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1978);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_803));
      }
