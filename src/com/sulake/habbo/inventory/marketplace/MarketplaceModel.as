package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_213 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_213.id);
            this.var_213 = null;
         }
      }
      ...
      {
         if(this.var_213 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_213 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_213.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_213 is FloorItem ? 1 : 2;
         this.var_2232 = _loc2_;
         this.var_2233 = this.var_213.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_213.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_213);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1637,this.var_1638);
         }
      }
      ...
      {
         if(param1 != this.var_2232 || param2 != this.var_2233)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2205);
      }
