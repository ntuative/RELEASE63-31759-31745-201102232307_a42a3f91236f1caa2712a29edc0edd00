   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_404.getBadgeImage(param1);
      ...
      public function method_8(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_254[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_254.length)
               {
                  if((this.var_254[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_254[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_312 && this._controller.isVisible)
         {
