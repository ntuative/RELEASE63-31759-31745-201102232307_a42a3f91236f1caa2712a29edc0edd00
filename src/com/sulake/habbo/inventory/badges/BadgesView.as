package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1094:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1094 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1094.procedure = this.inactiveGridEventProc;
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1094.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1094.getGridItemIndex(param1.window);
            _loc4_ = this.var_66.getBadgeFromInactive(_loc3_);
            if(_loc4_ != null)
            {
               this.var_66.method_8(_loc4_.type);
            }
         }
      }
