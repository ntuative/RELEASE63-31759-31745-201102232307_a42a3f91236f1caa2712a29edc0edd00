package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_948:uint = 4284532064;
      
      private static const const_947:uint = 2577770;
      
      public static const const_1012:int = 0;
      
      public static const const_1208:int = 1;
      
      public static const const_1131:int = 2;
      ...
      private var var_418:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_418 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_198)
            {
               this.var_198.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_198.stop();
               this.var_198 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1827 = this.createMinimizedWindow();
         }
         if(!this.var_2555)
         {
            return this.var_68;
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc10_:Map = !!_loc9_ ? this.var_21.method_2 : this.var_21.ownUserItems;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_948) : uint(const_947);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_948) : uint(const_947);
            }
         ...
         if(this.var_68)
         {
            ...
            switch(this.var_21.state)
            {
               case TradingModel.const_192:
                  if(this.var_21.method_2.length > 0 || this.var_21.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_198 = new Timer(1000,3);
            this.var_198.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_198.reset();
         this.var_198.repeatCount = 3;
         this.var_198.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_198.currentCount));
         if(this.var_198.currentCount == 3)
         {
      ...
      {
         var _loc2_:* = null;
         if(param1 < this.var_21.method_2.length)
         {
            _loc2_ = this.var_21.method_2.getWithIndex(param1) as GroupItem;
            this.setSelection(_loc2_);
            if(_loc2_)
            {
               this.var_21.getFurniInventoryModel().displayItemInfo(_loc2_);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  ...
                  {
                     case TradingModel.const_200:
                        if(this.var_21.method_2.length == 0 && !this.var_21.ownUserAccepts)
                        {
                           this.alertPopup(const_1012);
                        }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1171)
            {
            ...
            this.var_418.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_528);
            this.var_418.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_418.hideDelayed();
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_21.method_2.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
