   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_57)
         {
            ...
            {
               case "tab_floor":
                  this.var_66.switchCategory(FurniModel.const_44);
                  break;
               case "tab_wall":
                  this.var_66.switchCategory(FurniModel.const_49);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_55,this);
            if(_loc8_ != null)
            {
