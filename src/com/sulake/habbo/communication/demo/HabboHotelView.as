package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1070:Function;
      
      private var var_1069:Function;
      
      private var var_698:IAssetLibrary;
      
      private var var_1068:uint = 0;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         if(param1.type == AssetLoaderEvent.const_45)
         {
            ...
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.include));
            }
         }
         else if(param1.type == AssetLoaderEvent.const_28)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_519));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this._window && !this._window.disposed)
            {
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_698.loadAssetFromFile("hotel_view_banner_" + this.var_1068,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
