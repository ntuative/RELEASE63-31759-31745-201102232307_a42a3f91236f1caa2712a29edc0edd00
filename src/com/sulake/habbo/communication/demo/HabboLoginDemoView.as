package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_452:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_146.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_128,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1683,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_146.habboConfiguration.getKey("use.sso","RoomWidgetCreditFurniUpdateEvent") == "HabboCatalogCom_productViewWidget")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1683,"/");
         ...
         {
            dispatchEvent(new Event(const_452));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_123.removeEventListener(SSOTicket.const_365,this.onParsedTicketSuccess);
            this.var_123.removeEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
            this.var_123 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_123 = new SSOTicket(this.var_146.assets,_loc3_,_loc2_,param1);
         this.var_123.addEventListener(SSOTicket.const_365,this.onParsedTicketSuccess);
         this.var_123.addEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_123.ticket);
         Logger.log("Has Facebook: " + this.var_123.isFacebookUser);
         if(this.var_123.isFacebookUser)
         {
            this.var_146.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_146.shockwaveClientUrl = this.var_123.shockwaveClientUrl;
         this.var_146.ssoTicket = this.var_123.ticket;
         this.var_123.removeEventListener(SSOTicket.const_365,this.onParsedTicketSuccess);
         this.var_123.removeEventListener(SSOTicket.const_297,this.onParsedTicketFailure);
         this.var_123 = null;
         dispatchEvent(new Event(const_452));
