package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_495:IKeyExchange;
      
      private var var_923:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2440:PseudoRandom;
      ...
      private const const_1683:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_605 = param1;
            this.var_51.initConnection(HabboConnectionType.const_257);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_94,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_51 && this.var_153 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_153.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_153.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_219.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_153.getKey("use.sso.ticket") == "1";
         this.var_605 = this.var_153.getKey("sso.ticket",null);
         this.var_1769 = this.var_153.getKey("flash.client.url","");
         this.var_2442 = this.var_153.getKey("external.variables.txt","");
         if(this.var_219 == null)
         {
            this.var_219 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_51.mode = HabboConnectionType.const_84;
            if(this.var_605)
            {
               this.var_51.initConnection(HabboConnectionType.const_257);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_452,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_51.mode = HabboConnectionType.const_1137;
            }
         }
         this.var_51.initConnection(HabboConnectionType.const_257);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_693);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2440 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_51.mode)
         {
            case HabboConnectionType.const_84:
               _loc6_ = "";
               ...
               this.var_1394 = _loc4_;
               this.var_219.loadBannerImage(_loc7_ + "?token=" + this.var_1394,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1137:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1572:
               this.var_923 = this.generateRandomHexString(30);
               this.var_495 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_495.init(this.var_923);
               _loc8_ = this.var_495.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_495.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_495.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2440);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1395 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_220);
         connection.send(new VersionCheckMessageComposer(401,this.var_1769,this.var_2442));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1683,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_266);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_260);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2441)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1394);
         ...
         this.var_495 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_495.init(_loc14_);
            _loc15_ = this.var_495.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_923 = _loc14_;
            }
