package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_412:uint = 3;
      
      private static const const_1272:uint = 1;
      ...
      private var var_891:IWindowRenderer;
      
      private var var_892:ISkinContainer;
      
      private var var_337:Array;
      
      private var var_1359:IEventDispatcher;
      
      private var var_1099:Boolean = false;
      
      private var var_1694:ProfilerOutput;
      
      private var var_1361:ProfilerAgentTask;
      
      private var var_1360:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_892 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_891 = new WindowRenderer(this.var_892);
         this.var_194 = new Array(const_412);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_412)
         {
            this.var_194[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_891,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_194[const_1272];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_378,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1493,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1694)
            {
               this.var_1694 = new ProfilerOutput(context,this,this.var_891);
            }
            this.var_1694.profiler = _loc3_;
            this.var_1361 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1361);
            this.var_1360 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1360);
            this.var_1099 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_194)
            {
               ...
               {
                  IDisposable(this.var_194.pop()).dispose();
               }
            }
            this.var_194 = null;
            if(this.var_337)
      ...
      {
         return this.var_892.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_194[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_194[param2].getDesktopWindow();
      ...
      {
         return this.var_194[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_194[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_194[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1359.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_412 - 1;
            while(_loc2_ >= 0)
            {
               this.var_194[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1099)
         ...
         this.var_1359.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_412)
         {
            this.var_194[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1099)
         {
         ...
         this.var_1359.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1365,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1647,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1485,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1379,param2.name + ": " + param2.toString());
            }
         }
      }
