package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_898:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_836.setText(this.getTagFromEvent(param1,1));
         this.var_835.setText(this.getTagFromEvent(param1,2));
         this.var_1370.visible = false;
         this.var_1369.visible = true;
         this.var_1368.visible = true;
         this.var_1701.visible = false;
         this.var_1703.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_898.visible = true;
         this.var_1702.visible = false;
         ...
         this.var_835.goBackToInitialState();
         this.var_898.selection = 0;
         this.var_1701.visible = true;
         this.var_1703.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_898.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_836.getText());
         this.addTag(_loc6_,this.var_835.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1702 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2345 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1701 = ITextWindow(this.find("create_caption"));
            this.var_1703 = ITextWindow(this.find("edit_caption"));
            this.var_1370 = IButtonWindow(this.find("create_button"));
            this.var_1369 = IButtonWindow(this.find("edit_button"));
            this.var_2346 = IButtonWindow(this.find("cancel_button"));
            this.var_1368 = IButtonWindow(this.find("end_button"));
            this.var_898 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1370,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1369,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1368,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2346,this.onCancelButtonClick);
            ...
            this.var_836 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_835 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
