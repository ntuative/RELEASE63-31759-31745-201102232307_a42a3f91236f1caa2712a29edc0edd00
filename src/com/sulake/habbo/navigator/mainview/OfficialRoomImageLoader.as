package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private var var_956:IBitmapWrapperWindow;
      ...
      public function OfficialRoomImageLoader(param1:HabboNavigator, param2:String, param3:IBitmapWrapperWindow)
      {
         ...
         this.var_990 = _loc4_ + this.var_957;
      ...
      public function startLoad() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(this._navigator.assets.hasAsset(this.var_957))
         {
            this.setImage();
         }
         else
         {
            ...
            _loc2_ = this._navigator.assets.loadAssetFromFile(this.var_957,_loc1_,"image/gif");
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         Logger.log("IMAGE READY: " + this.var_957 + ", " + _loc2_);
         this.setImage();
      }
      
      private function setImage() : void
      {
         var _loc1_:BitmapData = this._navigator.getButtonImage(this.var_957,"");
         this.var_956.bitmap = _loc1_;
         this.var_956.width = _loc1_.width;
         this.var_956.height = _loc1_.height;
