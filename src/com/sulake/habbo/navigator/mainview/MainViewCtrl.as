package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_904:int = 1;
      
      private static const const_583:int = 2;
      
      private static const const_903:int = 3;
      
      private static const const_1220:int = 4;
      ...
      private var var_809:PopularTagsListCtrl;
      
      private var var_810:GuestRoomListCtrl;
      
      private var var_1003:OfficialRoomListCtrl;
      ...
      private var var_1001:Boolean = true;
      
      private var var_1243:int = 0;
      
      private var var_1242:IWindow;
      
      private var var_1002:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_809 = new PopularTagsListCtrl(this._navigator);
         this.var_810 = new GuestRoomListCtrl(this._navigator);
         this.var_1003 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_250 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_250)
         {
         ...
         this.var_1242 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1002 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1002)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1002.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_706,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1512,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_172,["custom_content","list_content"],this.var_203.y,8);
         this.var_186.height = this.var_186.height + _loc1_ - this.var_186.y - this.var_230.height + this.var_1995;
         Util.moveChildrenToColumn(this.var_172,["list_content","custom_footer"],this.var_186.y,0);
         this.var_1995 = this.var_230.height;
      ...
      {
         this.refreshList(param1,param2,this.var_810,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_809,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1003,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_539 == const_904)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_186.blend - _loc2_));
            this.var_186.blend = _loc3_;
            this.var_203.blend = !!this.var_1001 ? Number(_loc3_) : Number(1);
            this.var_230.blend = !!this.var_1001 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_539 = const_583;
            }
         }
         else if(this.var_539 == const_583)
         {
            if(this.var_1243 % 10 == 1)
            {
               this.var_1242.visible = !this.var_1242.visible;
            }
            ++this.var_1243;
            if(!this._navigator.data.isLoading())
            {
               this.var_539 = const_903;
            }
         }
         else if(this.var_539 == const_903)
         {
            this.refresh();
            this.var_539 = const_1220;
         }
         else
         {
            this.var_1242.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_186.blend + _loc2_));
            this.var_186.blend = _loc3_;
            this.var_203.blend = !!this.var_1001 ? Number(_loc3_) : Number(1);
            this.var_230.blend = !!this.var_1001 ? Number(_loc3_) : Number(1);
      ...
      {
         this.refreshScrollbar(this.var_809);
         this.refreshScrollbar(this.var_810);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1002,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1002,"icon_hotelview_reactive",param1,null,0);
      }
