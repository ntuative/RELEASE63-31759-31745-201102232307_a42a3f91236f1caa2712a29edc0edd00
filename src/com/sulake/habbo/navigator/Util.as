package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1287:CutToWidth = new CutToWidth();
      
      private static var var_1288:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1287.beforeSearch(param2,param1,param3);
         binarySearch(var_1287,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1288.beforeSearch(param2,param1,param3);
         binarySearch(var_1288,param2.length - 1);
      }
