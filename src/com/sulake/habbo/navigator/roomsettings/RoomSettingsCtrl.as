package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_386:IRoomSettingsCtrlOwner;
      ...
      private var var_674:TextFieldManager;
      ...
      private var var_837:TextFieldManager;
      ...
      private var var_1044:ICheckBoxWindow;
      
      private var var_552:ICheckBoxWindow;
      ...
      private var var_2144:ITextWindow;
      ...
      {
         this.var_323 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_323));
         if(this.var_1040 != null)
         {
            this.var_1040.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_323)
         {
            return;
         }
         this.var_75 = param1;
         this._active = true;
         this.var_1580 = true;
         this.var_386.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_323)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_323 || this.var_1046 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1046 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1591)
         {
            this.var_674.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1428)
         {
            this.var_674.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1450)
         {
            this.var_1043.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1421)
         {
            this.setTagError(this.var_836,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_835,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1584)
         {
            this.setTagError(this.var_836,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_835,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1632)
         {
            this.var_837.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_674.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_674.clearErrors();
         this.var_1043.clearErrors();
         this.var_836.clearErrors();
         this.var_835.clearErrors();
         this.var_837.clearErrors();
         this.var_1045.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_453,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_832,this.onDoorModePasswordUnselect);
         ...
         this.var_674 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1043 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_836 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_835 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_837 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1045 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1042 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1038 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1044 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_552 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1578 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1279 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1039 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1041 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1579 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1280 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_233 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1040 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2144 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2143 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1578.visible = this._inRoom;
         this.var_1579.visible = this._inRoom;
         this.var_2143.visible = this.var_467;
         this.var_2144.visible = !this.var_467;
         if(this.var_467)
         {
            this.var_1041.visible = true;
            this.var_1280.visible = false;
         ...
         else
         {
            ...
            this.var_1280.visible = true;
            this.var_1279.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1279.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1039.height = Util.getLowestPoint(this.var_1039) + 4;
         }
         this.var_1581.text = !!this.var_467 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1578.name,this.var_1279.name,this.var_1039.name,this.var_1041.name,this.var_1280.name,this.var_1579.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_674.setText(_loc1_.name);
         this.var_1043.setText(_loc1_.description);
         this.var_837.setText("");
         this.var_1045.setText("");
         ...
         this.setTag(this.var_836,_loc1_.tags[0]);
         this.setTag(this.var_835,_loc1_.tags[1]);
         if(this.var_1042)
         {
            if(_loc1_.allowPets)
            {
               this.var_1042.select();
            }
            else
            {
               this.var_1042.unselect();
            }
         }
         if(this.var_1038)
         {
            ...
            {
               this.var_1038.select();
            }
            else
            {
               this.var_1038.unselect();
            }
         }
         if(this.var_1044)
         {
            ...
            {
               this.var_1044.select();
            }
            else
            {
               this.var_1044.unselect();
            }
         }
         if(this.var_552)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_674.getText();
         _loc2_.description = this.var_1043.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_570;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_122)
         {
            _loc8_ = this.var_837.getText();
            _loc9_ = this.var_1045.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_837.clearErrors();
               this.var_1045.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1042.isSelected;
         _loc2_.allowFoodConsume = this.var_1038.isSelected;
         _loc2_.allowWalkThrough = this.var_1044.isSelected;
         _loc2_.hideWalls = this.var_552.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_836,_loc2_.tags);
         this.addTag(this.var_835,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_323);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_323]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_233.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_233.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_233.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_233.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_233.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_233.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_233.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_233);
         this.var_233.findChildByName("ruler").visible = true;
         ...
         if(this.var_75.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_233,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_61,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_323));
      }
