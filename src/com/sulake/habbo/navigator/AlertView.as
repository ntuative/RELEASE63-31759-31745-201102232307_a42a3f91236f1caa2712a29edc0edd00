package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_544:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_544[this.var_989] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_989,2) as IFrameWindow;
