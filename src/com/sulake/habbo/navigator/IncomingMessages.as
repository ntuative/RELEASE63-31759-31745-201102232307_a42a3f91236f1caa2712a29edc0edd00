package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1040)
            {
               this._navigator.data.eventMod = true;
            }
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1519)
            {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_181 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "HabboCatalogCom_productViewWidget" && false)
         {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.EXITROOM);
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_222);
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1656:
            ...
            case CantConnectMessageParser.const_1484:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1536:
