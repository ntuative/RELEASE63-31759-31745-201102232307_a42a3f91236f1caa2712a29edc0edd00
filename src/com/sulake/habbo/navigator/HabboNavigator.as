package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_308:MainViewCtrl;
      
      private var var_620:RoomInfoViewCtrl;
      
      private var var_1160:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_437:Tabs;
      ...
      private var var_2148:RoomThumbnailRenderer;
      
      private var var_837:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_308 = new MainViewCtrl(this);
         this.var_620 = new RoomInfoViewCtrl(this);
         this.var_1160 = new RoomCreateViewCtrl(this);
         this.var_2148 = new RoomThumbnailRenderer(this);
         this.var_837 = new GuestRoomPasswordInput(this);
         this.var_362 = new GuestRoomDoorbell(this);
         this.var_437 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_620.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_173.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_308.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_308.startSearch(Tabs.const_250,Tabs.const_388,param1);
         this.var_308.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_308.startSearch(Tabs.const_305,Tabs.const_222);
         this.var_437.getTab(Tabs.const_305).tabPageDecorator.tabSelected();
      }
