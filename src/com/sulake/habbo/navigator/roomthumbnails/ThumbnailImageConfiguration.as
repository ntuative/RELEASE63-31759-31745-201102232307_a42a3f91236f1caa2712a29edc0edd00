package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1917:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1915 = this._navigator.getButtonImage(this.var_1916);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1917 == null)
         {
            ...
            this.var_1917 = new Rectangle(this.var_1462,this.var_1462,_loc1_.width - 2 * this.var_1462,_loc1_.height - 2 * this.var_1462);
         }
         this.var_640.bitmap.fillRect(this.var_640.bitmap.rect,4281545523);
         this.var_640.bitmap.fillRect(this.var_1917,4284900966);
         this.copyTo(this.var_640.bitmap);
         if(this.var_193)
         {
            this.var_640.bitmap.copyPixels(this.var_1918,this.var_1918.rect,new Point(0,0),null,null,true);
         }
