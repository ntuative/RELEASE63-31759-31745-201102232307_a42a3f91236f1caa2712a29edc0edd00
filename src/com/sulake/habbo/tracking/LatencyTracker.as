package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_173 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1641 = int(this.var_173.getKey("latencytest.interval"));
         this.var_1644 = int(this.var_173.getKey("latencytest.report.index"));
         this.var_2240 = int(this.var_173.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1643 > this.var_1641)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1643 = getTimer();
         this.var_572.add(this.var_1327,this.var_1643);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_572 == null || this.var_212 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_572.getValue(_loc2_.requestId);
         this.var_572.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_212.push(_loc4_);
         if(this.var_212.length == this.var_1644 && this.var_1644 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1642) > this.var_2240 || this.var_1642 == 0)
            {
