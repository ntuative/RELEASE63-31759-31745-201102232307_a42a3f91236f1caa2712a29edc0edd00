package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1081:IHabboWindowManager;
      ...
      private var var_244:PerformanceTracker = null;
      
      private var var_578:FramerateTracker = null;
      
      private var var_243:LatencyTracker = null;
      
      private var var_576:LagWarningLogger = null;
      
      private var var_577:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_244 = new PerformanceTracker();
         this.var_578 = new FramerateTracker();
         this.var_243 = new LatencyTracker();
         this.var_576 = new LagWarningLogger();
         this.var_577 = new ToolbarClickTracker(this);
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1458,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1459,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1527,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_634,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1174,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1081)
            {
               this.var_1081.release(new IIDHabboWindowManager());
               this.var_1081 = null;
            }
            if(this.var_285)
            {
            ...
            if(this.var_192)
            {
               if(!this.var_192.disposed)
               {
                  ...
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.const_357,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_181)
            {
               ...
               {
                  this.var_181.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
               }
      ...
      {
         this.var_173 = IHabboConfigurationManager(param2);
         if(this.var_173)
         {
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_173;
            }
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_173;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1609);
            if(this.var_173)
            {
               if(this.var_576 != null)
               {
                  this.var_576.configure(this.var_173);
               }
               if(this.var_578 != null)
               {
                  this.var_578.configure(this.var_173);
               }
               if(this.var_577 != null)
               {
                  this.var_577.configure(this.var_173);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_157);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_693,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_220,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_266,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_260,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_700,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.include,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_519,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_244 != null)
            {
               this.var_244.connection = param1;
            }
            if(this.var_243 != null)
            {
            ...
            if(this.var_576 != null)
            {
               this.var_576.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1456);
         }
         else if(param1.type == HabboHotelViewEvent.const_519)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1623);
         }
         else if(param1.type == HabboHotelViewEvent.include)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1521);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1537);
               break;
            case HabboCommunicationEvent.const_693:
               this.trackLoginStep(HabboLoginTrackingStep.const_1566,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_220:
               this.trackLoginStep(HabboLoginTrackingStep.const_220);
               break;
            ...
            case HabboCommunicationEvent.const_199:
               ...
               break;
            case HabboCommunicationEvent.const_266:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_266);
               if(this.var_243 != null)
               {
                  this.var_243.init();
               }
               break;
            case HabboCommunicationEvent.const_260:
               this.trackLoginStep(HabboLoginTrackingStep.const_260);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1081 = IHabboWindowManager(param2);
         if(this.var_1081)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_173)
            {
               if(this.var_173.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_173.getKey("client.fatal.error.url");
                  ...
                  if(this.var_244 != null)
                  {
                     _loc4_["null"] = this.var_244.flashVersion;
                     _loc4_["null"] = this.var_244.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1121);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1121,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.const_357,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2259)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1624);
            this.var_2259 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1174,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_634,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_283,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_285 = param2 as IAdManager;
         this.var_285.events.addEventListener(AdEvent.const_427,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_181 = param2 as IHabboToolbar;
         this.var_181.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_577)
         {
            this.var_577.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_173 != null && !Boolean(this.var_173.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_576.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1650;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1650);
         }
         if(this.var_477 > -1 && _loc2_ - this.var_477 > 15000)
         {
            ++this.var_1651;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1651);
         }
         this.var_477 = _loc2_;
         if(this.var_244 != null)
         {
            this.var_244.update(param1,this.var_477);
         }
         if(this.var_243 != null)
         {
         ...
         if(this.var_578 != null)
         {
            this.var_578.trackUpdate(param1,this,this.var_477);
         }
         if(this.var_576 != null)
         {
            this.var_576.update(this.var_477);
         }
      }
   }
}
