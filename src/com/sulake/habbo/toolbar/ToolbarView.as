package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_503:String = "LEFT";
      
      private var var_157:Number = 50;
      
      private var var_1159:Boolean = true;
      
      private var var_1158:Number = 1;
      
      private var var_1420:Number = 0;
      
      private var var_1823:Number = 15;
      
      private var var_1822:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2774 = new Array();
         ...
         this.var_224 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_1122,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1159 = String(_loc6_.relocate_by_drag.@state) == "HabboCatalogCom_productViewWidget";
         if(this.var_1159)
         {
         ...
         this.var_1158 = _loc6_.toolbar.@margin_top;
         this.var_1420 = _loc6_.toolbar.@margin_bottom;
         this.var_1823 = _loc6_.toolbar.@min_group_margin;
         this.var_1822 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_304 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_258,param1,param2,this._window,this.var_304);
         this.createGroupsFromXmlList(_loc8_,this.var_619,param1,param2,this.var_224,this.var_304);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_157);
      ...
      public function dispose() : void
      {
         ...
         while(this.var_619.length > 0)
         {
            _loc1_ = this.var_619.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_157,this.var_503,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_503);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_157,this.var_503);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_157,this.var_503);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_224 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_224.x = this.var_157 + this.var_1822;
               this.var_224.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_224.x = 0;
               this.var_224.y = this.var_157 + this.var_1822;
         ...
         _loc4_ -= this.var_1420;
         _loc4_ -= this.var_1158;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1158;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_258.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1823,(this._window.height - _loc5_ * _loc8_ - this.var_1158 - this.var_1420) / (this.var_258.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1823,(this._window.width - _loc5_ * _loc8_ - this.var_1158 - this.var_1420) / (this.var_258.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_258.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_503;
