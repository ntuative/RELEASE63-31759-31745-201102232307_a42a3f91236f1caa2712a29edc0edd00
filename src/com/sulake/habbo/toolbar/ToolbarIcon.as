package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1123:String = "-1";
      
      private var var_304:ToolbarBarMenuAnimator;
      
      private var var_1126:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1126 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_491 = param1;
      ...
      public function set exists(param1:Boolean) : void
      {
         ...
         if(this._region != null)
         {
            this._region.visible = this.var_1125;
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_1388 = param1.@id;
         this.var_2426 = int(param1.@window_offset_from_icon);
         this.var_2119 = int(param1.@window_margin);
         this.var_2770 = param1.@label;
         var _loc2_:XMLList = param1.elements("state");
         if(_loc2_.length() > 0)
         {
            if(param1.attribute("state_over").length() > 0)
            {
               this.var_1387 = param1.@state_over;
            }
            if(param1.attribute("state_default").length() > 0)
            {
               this.var_1123 = param1.@state_default;
            }
            _loc3_ = 0;
            while(_loc3_ < _loc2_.length())
            {
               ...
               if(_loc3_ == 0)
               {
                  ...
                  if(this.var_1123 == "-1")
                  {
                     this.var_1123 = _loc5_.id;
                  }
               }
               _loc3_++;
            }
         }
         this._state = this.var_1123;
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && this.var_1125)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            this.var_604 = new ToolbarIconAnimator(_loc1_,this._assetLibrary,this._icon,this._x,this.var_158,this._bitmapData);
            if(this.var_604.frameCount > 0)
            {
               this.var_918 = new Timer(_loc1_.timer);
               this.var_918.addEventListener(TimerEvent.TIMER,this.updateAnimator);
               this.var_918.start();
            }
            if(_loc1_.bounce)
            {
               this.var_1126.reset(-7);
               this.var_1389.reset();
               this.var_1389.start();
            }
         }
      ...
      {
         var _loc4_:* = null;
         if(this.var_743.indexOf(param1) < 0)
         {
            this.var_743.push(param1);
            _loc4_ = new MenuSettingsItem(param1,param2,param3);
            this.var_1127.push(_loc4_);
         }
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1127[this.var_743.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         ...
         {
            this.var_304.animateWindowIn(this,param1,param2,this.var_744,param3,param4,this.getMenuYieldList(param1));
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_304 != null)
         {
            this.var_304.positionWindow(this,param1,param2,this.var_744,param3,this.getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_304 != null)
         {
            this.var_304.hideWindow(param1,param2,this.var_744,param3);
         }
      }
      ...
      {
         return this.var_1752[this.var_1124.indexOf(param1)];
      }
      ...
      private function setTooltip() : void
      {
         ...
         {
            this._region.toolTipCaption = "${toolbar.icon.tooltip." + this.var_1388.toLowerCase() + "}";
         }
      ...
      private function setLabel() : void
      {
         ...
         {
            this.var_347.caption = "${toolbar.icon.label." + this.var_1388.toLowerCase() + "}";
         }
         this.updateRegion();
      }
      ...
      {
         return this.var_2119 + this.var_491.windowMargin;
      }
      ...
      {
         if(this.var_1126 != null && this._icon != null)
         {
            this.var_1126.update();
            this._icon.y = this.var_1126.location;
         }
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(this.var_304)
               {
                  this.var_304.repositionWindow(this.var_744,true);
               }
               if(this._events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_38);
                  _loc4_.iconId = this.var_744;
                  _loc4_.iconName = this.var_1388;
      ...
      private function updateRegion() : void
      {
         ...
         var _loc1_:Boolean = this.var_491.orientation == "LEFT" || this.var_491.orientation == "RIGHT";
         if(_loc1_)
         {
            this._x = (this.var_491.toolbarUsableWidth - this._region.width) / 2;
            this.var_158 = this.var_1098 + (this.var_491.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_1098 + (this.var_491.iconSize - this._region.width) / 2;
            this.var_158 = (this.var_491.toolbarUsableWidth - this._region.height) / 2;
         }
