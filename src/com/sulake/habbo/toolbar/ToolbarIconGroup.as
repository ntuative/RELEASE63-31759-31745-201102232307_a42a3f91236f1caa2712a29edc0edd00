package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1269.indexOf(param1) > -1;
      }
            ...
            if(_loc2_ != null)
            {
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        this.var_1269.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "HabboCatalogCom_productViewWidget");
                        _loc9_++;
                     }
                  }
                  else
                  {
                     this.var_1269.push(_loc2_);
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2122.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_667.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1268.length)
         {
            _loc2_ = this.var_667.indexOf(this.var_1268[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_278[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1098 + _loc3_);
                  _loc3_ += this.var_1270;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_278[this.var_667.indexOf(param1)];
      }
