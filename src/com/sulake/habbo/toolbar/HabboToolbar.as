package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1464:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_294.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","RoomWidgetCreditFurniUpdateEvent") == "HabboCatalogCom_productViewWidget")
         {
            this.var_1464 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1127,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_130,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_102,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_52,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_522,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1085,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1023,this.onHideWindowEvent);
         this._state = true;
