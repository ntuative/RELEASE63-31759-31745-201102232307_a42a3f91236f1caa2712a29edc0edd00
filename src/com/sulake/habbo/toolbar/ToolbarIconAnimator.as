package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1532 = param1.nextState;
         this.var_1334 = param1.loop;
         if(param1.background != null)
         {
            this.var_881 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_883.push(new XML());
               this.var_882.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_882[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1334 == true || this.var_884 == 0)
         {
            if(this.var_883.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_883.length)
               {
                  this._frame = 0;
                  ++this.var_884;
               }
      ...
      {
         return this.var_883.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1334 == false && this.var_884 == 1 && this.var_1532 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_882.length)
         {
            _loc2_ = this.var_882[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_881.width),Math.max(param2.height,this.var_881.height));
            _loc3_.copyPixels(this.var_881,this.var_881.rect,new Point(0,0));
