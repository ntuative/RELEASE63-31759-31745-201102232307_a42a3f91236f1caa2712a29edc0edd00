package com.sulake.habbo.toolbar
{
   public class StateItem
   {
      ...
      private var var_1532:String = "-1";
      
      private var var_1573:String = "-1";
      ...
      public function StateItem(param1:XML, param2:String)
      {
         ...
         {
            this.var_1334 = Boolean(param1.@loop);
         }
         if(param1.attribute("bounce").length() > 0)
         {
            this.var_2134 = Boolean(param1.@loop);
         }
         ...
         {
            this.var_1532 = this._id;
         }
         if(param1.attribute("state_default").length() > 0)
         {
            this.var_1573 = param1.@state_default;
         }
         if(param1.attribute("tooltip").length() > 0)
         {
            this.var_2135 = param1.@tooltip;
         }
         if(param1.attribute("background").length() > 0)
         {
            this.var_442 = param1.@background;
         }
