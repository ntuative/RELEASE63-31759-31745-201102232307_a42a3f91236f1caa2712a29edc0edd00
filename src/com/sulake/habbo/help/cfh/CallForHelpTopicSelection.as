package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      override public function render() : void
      {
         ...
         this.var_681 = new Array();
         for each(_loc5_ in _loc4_)
         {
            _loc7_ = int(_loc5_.replace(" ",""));
            if(_loc7_ != 0)
            {
               this.var_681.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_681.length)
         {
            _loc8_ = this.var_681[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_681 == null || _loc3_ < 0 || _loc3_ >= this.var_681.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_681[_loc3_];
            main.showUI(HabboHelpViewEnum.const_813);
            main.tellUI(HabboHelpViewEnum.const_813,null);
         }
      }
   }
}
