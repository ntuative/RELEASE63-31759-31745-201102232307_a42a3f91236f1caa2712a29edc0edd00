package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_682 = main.component.userRegistry.getRegistry();
         if(this.var_682.length == 0)
         {
            main.showUI(HabboHelpViewEnum.const_193);
         ...
         var i:int = 0;
         while(i < this.var_682.length)
         {
            user = this.var_682.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_682.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_682.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
