package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_771)
         {
            this.var_771 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_771)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_770)
         {
            this.var_770 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_770)
            {
               return;
            }
