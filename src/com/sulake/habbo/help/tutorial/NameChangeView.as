package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1435:uint = 13232628;
      ...
      private var var_1848:IWindowContainer;
      ...
      {
         return TutorialUI.const_322;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_510 = param1;
         if(this.var_1849 == this.var_510)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1848 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_771)
         {
            this.var_771 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_771)
            {
               return;
            }
            this._window.content.addChild(this.var_771);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_770)
         {
            this.var_770 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_770)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_770.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_510;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_510);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_793:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_987:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_988:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_988 || param1 == ChangeUserNameResultMessageEvent.var_987)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1173 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1173.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1435;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_510 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_510);
               break;
