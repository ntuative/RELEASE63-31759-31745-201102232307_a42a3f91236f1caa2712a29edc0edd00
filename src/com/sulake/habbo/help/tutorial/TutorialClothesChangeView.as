package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_33.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_52,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_33.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_52,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_52)
         {
            ...
            this.var_33.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_499));
         }
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_766 = this.var_33.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_766.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_33.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU_ARROW,this.var_766));
      }
