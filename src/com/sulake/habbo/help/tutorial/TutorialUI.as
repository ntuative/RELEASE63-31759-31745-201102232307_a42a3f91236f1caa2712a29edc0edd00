package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_354:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_349:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_533,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_573,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_581,this.onTaskDoneEvent);
      ...
      {
         return this.var_1152 && this.var_1151 && this.var_1410;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_533,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_573,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_581,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_42 == null || this.var_42.id == const_92)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_533:
               this.var_1410 = true;
               if(this.var_42 != null && this.var_42.id == const_481)
               {
                  this.showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_573:
               if(this.var_42 != null && this.var_42.id == const_354)
               {
                  this.var_1812 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2514 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_322:
               ...
               if(this.var_349 == null)
               {
                  this.var_349 = new NameChangeView(this);
               }
               this.var_349.showMainView();
               this.prepareForTutorial();
               break;
            case const_354:
         ...
         this._window.height = _loc2_.height + this.var_2515;
         this._window.width = _loc2_.width + this.var_2514;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_42 != null && (this.var_42.id == const_322 || this.var_42.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      {
         this.var_1152 = true;
         if(this.var_42 != null && (this.var_42.id == const_354 || this.var_42.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_527)
         {
            this.var_1151 = true;
         ...
         {
            this.var_349.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_527)
         {
            this.var_349.checkedName = _loc2_.name;
         }
         else
         {
            this.var_349.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
