package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102232302));
         this.var_181 = param5;
         this.var_116 = new Map();
         this.var_116.add(HabboHelpViewEnum.const_1419,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_193,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_514,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_314,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_271,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_386,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_813,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_216,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_116.add(HabboHelpViewEnum.const_1159,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_116.add(HabboHelpViewEnum.const_1091,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_741,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_504.length == 0 || param1 != this.var_355)
            {
               this.var_504.push(this.var_355);
            }
         }
         this.var_355 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_216:
               ...
               break;
            case CallForHelpResultEnum.const_1071:
               this.showUI(HabboHelpViewEnum.const_1091);
               break;
            case CallForHelpResultEnum.const_993:
               this.showUI(HabboHelpViewEnum.const_1159);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_116.getValue(HabboHelpViewEnum.const_193) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_533));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2514 = this._window.width - _loc4_.width;
         this.var_2515 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2515;
         this._window.width = _loc1_.width + this.var_2514;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_504.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_193)
         {
            return;
         }
         if(this.var_622.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_622.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_622[1],this.var_622[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_622[0],this.var_622[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_193 || this.var_504.length == 0)
         {
            return;
         }
         if(this.var_356 == null)
         {
            ...
            this.var_356 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_356.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_356.findChildByName("back_text");
            if(_loc5_ != null)
            {
