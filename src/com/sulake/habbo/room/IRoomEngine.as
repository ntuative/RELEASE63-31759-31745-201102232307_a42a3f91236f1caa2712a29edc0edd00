package com.sulake.habbo.room
{
   ...
   public interface IRoomEngine extends IUnknown
   {
      ...
      function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:uint = 0, param6:String = null, param7:int = -1) : ImageResult;
      
      function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1) : ImageResult;
      
      function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:uint = 0, param6:String = null, param7:int = -1) : ImageResult;
      ...
      function method_3(param1:int, param2:int, param3:int, param4:String = null) : Boolean;
