package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1256:int = -1.0E9;
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_677);
         var _loc8_:int = 0;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_987:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1024:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1045,_loc3_.status);
         }
      }
