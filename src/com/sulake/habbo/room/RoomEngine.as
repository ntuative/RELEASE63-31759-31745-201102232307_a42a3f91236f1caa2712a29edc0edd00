package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_609:String = "temporary_room";
      
      private static const const_330:int = -1;
      
      private static const const_610:String = "room";
      
      private static const const_969:int = -2;
      
      private static const const_1364:String = "tile_cursor";
      
      private static const const_971:int = -3;
      
      private static const const_1363:String = "selection_arrow";
      
      private static const const_970:String = "overlay";
      
      private static const const_331:String = "object_icon_sprite";
      
      private static const const_420:int = 15;
      ...
      private var var_984:IRoomRendererFactory = null;
      
      private var var_24:IRoomObjectFactory = null;
      
      private var var_497:IRoomObjectVisualizationFactory = null;
      ...
      private var var_789:NumberBank;
      
      private var var_1211:Map;
      
      private var var_524:Boolean = false;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_789 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_497.release(new IIDRoomObjectVisualizationFactory());
            this.var_497 = null;
         }
         if(this.var_46 != null)
         {
         ...
         {
            this.var_984.release(new IIDRoomRendererFactory());
            this.var_984 = null;
         }
         ...
         if(this.var_285)
         {
            this.var_285.release(new IIDHabboAdManager());
            this.var_285 = null;
         }
         ...
         if(this.var_371 != null)
         {
            ...
            {
               _loc2_ = this.var_371.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_371.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_371.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_46 != null)
         {
            ...
            _loc2_ = this.var_46.getRoom(this.getRoomIdentifier(this.var_101,this.var_102));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc11_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_371.length)
         {
            _loc3_ = this.var_371.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_101 || _loc6_ != this.var_102 || !this.var_1210)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_647) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_690) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_742) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_709) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_497 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_497;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_46 != null)
         {
            ...
            this.var_46.addObjectUpdateCategory(RoomObjectCategoryEnum.const_318);
            this.var_46.addObjectUpdateCategory(RoomObjectCategoryEnum.const_75);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_984 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_835,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_835)
         {
            this.var_2704 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_285 = param2 as IAdManager;
         this.var_285.events.addEventListener(AdEvent.const_427,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_404;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_24 != null)
         {
            ...
            {
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_225,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_523,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_503,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_126,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_720,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_148,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_510,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_458,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_556,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_501,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_485,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_448,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_283,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_516,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_389,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_371,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_525,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_1022,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_488,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_24 == null || this.var_497 == null || this.var_46 == null || this.var_984 == null || this._communication == null || this.var_153 == null || !this.var_2704)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_524 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_689,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1003,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_454,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1003);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_901,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1177,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_618,1,true);
            _loc13_ = parseInt(this.var_153.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1200,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_330,const_610,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_618,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_677,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_647,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_742,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_690,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_709,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1202,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_890,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_619,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_477,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_254);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_673,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_705,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_673,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_705,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1031,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_978,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_969,const_1364,RoomObjectCategoryEnum.const_318);
         if(this.var_153.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_971,const_1363,RoomObjectCategoryEnum.const_318);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_330,RoomObjectCategoryEnum.const_75);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_372.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_372.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_890,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_619,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1429,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1052,param3);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_371.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_692,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_984.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1187;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_677);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_673);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_705);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1031);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_978);
      ...
      {
         var _loc8_:int = param2 - this.var_1469;
         var _loc9_:int = param3 - this.var_1468;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1210 = true;
               this.var_983 = false;
               this.var_2702 = this.var_1469;
               this.var_2703 = this.var_1468;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1210)
            {
               if(!this.var_983)
               {
                  _loc8_ = param2 - this.var_2702;
                  _loc9_ = param3 - this.var_2703;
                  if(_loc8_ <= -const_420 || _loc8_ >= const_420 || _loc9_ <= -const_420 || _loc9_ >= const_420)
                  {
                     this.var_983 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_101,this.var_102,param1);
         if(_loc9_ != null)
         {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_529,this.var_101,this.var_102,-1,RoomObjectCategoryEnum.const_165));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_74 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_330,const_610);
                     this.var_74.handleRoomObjectEvent(_loc14_,this.var_101,this.var_102);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_970) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_101,this.var_102,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_101,this.var_102,this.var_1470);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1469 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1468 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_101,this.var_102,this.var_1470);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_101,this.var_102,this.var_1470);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_74 != null)
         {
            return this.var_74.modifyRoomObject(this.var_101,this.var_102,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_74 != null)
         {
            ...
            {
               return this.var_74.modifyWallItemData(this.var_101,this.var_102,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_74 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_74.deleteWallItem(this.var_101,this.var_102,param1);
            }
         }
         return false;
      }
      
      public function method_3(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_101,this.var_102);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_618) != 0)
         {
            return false;
         }
         if(this.var_74 != null)
         {
            return this.var_74.method_3(this.var_101,this.var_102,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_74 != null)
         {
            this.var_74.cancelRoomObjectInsert(this.var_101,this.var_102);
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_165;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_971,RoomObjectCategoryEnum.const_318);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_969,RoomObjectCategoryEnum.const_318);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_234,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_400,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_350,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1048,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1192,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1086,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_313,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_234,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_400,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_350,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1187,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_313,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1130) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_997);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_477,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_662,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_313,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_857,this.var_101,this.var_102,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_74 != null)
         {
            this.var_74.handleRoomObjectEvent(param1,this.var_101,this.var_102);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_234));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_500);
                     break;
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_198);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_179,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_156,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_156,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_300,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_740,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_670,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_664,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_477,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_524 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_46.getRoom(const_609);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_46.createRoom(const_609,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_789.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_234,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_500,param7);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc13_.getModelController().setString(RoomObjectVariableEnum.const_198,param2);
               }
               else
               {
         ...
         if(param8 > -1)
         {
            _loc17_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_86);
         ...
         {
            this.var_1211.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1207,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_789.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_101,this.var_102,const_330,RoomObjectCategoryEnum.const_75,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_46.getRoom(const_609);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1207);
               ...
               this.var_789.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1211.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1008,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_981,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1113,RoomObjectVariableEnum.const_391,param1.clickUrl);
