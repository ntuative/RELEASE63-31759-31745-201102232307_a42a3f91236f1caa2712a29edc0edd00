   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_234,_loc3_ + 1);
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_556,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
