package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1471:uint = 16777215;
      
      private var var_1928:int = 255;
      
      private var var_1213:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1173,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_643,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_680,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_707,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_806,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1214)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1639;
            if(_loc2_ - this.var_1214 >= this.var_1926)
            {
               _loc3_ = this.var_1213;
               _loc4_ = this.var_1927;
               this.var_1214 = 0;
            }
            else
            {
               _loc7_ = this.var_1471 >> 16 & 255;
               _loc8_ = this.var_1471 >> 8 & 255;
               _loc9_ = this.var_1471 & 255;
               _loc10_ = this.var_1213 >> 16 & 255;
               _loc11_ = this.var_1213 >> 8 & 255;
               _loc12_ = this.var_1213 & 255;
               _loc13_ = (_loc2_ - this.var_1214) / this.var_1926;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1928 + (this.var_1927 - this.var_1928) * _loc13_;
               this._color = _loc3_;
               this.var_1639 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_643,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_890:
               param2.setString(RoomObjectVariableEnum.const_740,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_619:
               param2.setString(RoomObjectVariableEnum.const_670,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_477:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_254)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_662:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_996,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1180:
               param2.setNumber(RoomObjectVariableEnum.const_680,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1052:
               param2.setNumber(RoomObjectVariableEnum.const_707,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_806,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1083,int(param1.bgOnly));
         this.var_1471 = this._color;
         this.var_1928 = this.var_1639;
         this.var_1213 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1423,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1627,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1550,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_179)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_156 || _loc13_ == RoomPlaneData.const_300)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
