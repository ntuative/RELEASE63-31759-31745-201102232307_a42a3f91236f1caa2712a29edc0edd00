package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_750:DirectionData = null;
      
      private var var_256:Map;
      
      private var _colors:Map;
      
      private var var_1144:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_750 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_256 != null)
         {
            ...
            {
               _loc2_ = this.var_256.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_750,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_256.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_750);
            this.defineDirection(_loc3_,_loc8_);
            this.var_256.add(String(_loc7_),_loc3_);
            this.var_1801 = -1;
            this.var_1144 = null;
            _loc5_++;
         }
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1123);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_256.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_256.getKey(_loc5_)) * this.var_1402;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_256.getKey(_loc4_));
         }
         return const_1502;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_256.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_750;
         }
         this.var_1801 = param1;
         this.var_1144 = _loc2_;
         return this.var_1144;
      }
