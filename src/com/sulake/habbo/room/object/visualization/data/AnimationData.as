package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1805:int = 0;
      ...
      private var var_114:Map = null;
      
      private var var_392:int = -1;
      
      private var var_1851:Boolean = false;
      
      private var var_1436:Array = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_114 != null)
         {
            ...
            {
               _loc2_ = this.var_114.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1436 != null && this.var_1436.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_392;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_114.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_392)
         {
            this.var_392 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_114.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_114.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
