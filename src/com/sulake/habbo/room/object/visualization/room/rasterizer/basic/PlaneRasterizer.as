package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_582:String = "default";
       
      
      private var var_740:IGraphicAssetCollection = null;
      
      private var var_357:Map = null;
      
      private var var_191:Map = null;
      
      private var var_133:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_133 != null)
         {
            ...
            {
               _loc2_ = this.var_133.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_191.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_191.getValue(param1) as PlaneTexture;
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_133.getValue(param1) == null)
         {
            this.var_133.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(this.var_191.getValue(_loc6_) == null)
               {
                  ...
                  this.var_191.add(_loc6_,_loc7_);
               }
            }
            _loc4_++;
         }
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_740.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
