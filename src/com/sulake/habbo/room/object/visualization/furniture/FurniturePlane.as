package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      {
         if(param1 != this.var_2252)
         {
            if(!param1)
            {
               this.var_288.assign(this.var_701);
               this.var_289.assign(this.var_700);
            }
            else
            {
               this.var_288.assign(this.var_701);
               this.var_288.mul(this.var_700.length / this.var_701.length);
               this.var_289.assign(this.var_700);
               this.var_289.mul(this.var_701.length / this.var_700.length);
            }
            this.var_1503 = -1;
            this.var_1332 = this.var_1332 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_288.length * param1.scale);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_80 == null && this.var_1079 != null || this.var_288 == null || this.var_289 == null || this.var_575 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1503)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1332 || _loc4_.y != this.var_2253 || _loc4_.z != this.var_2255 || param1.scale != this.var_2254))
            {
               this.var_1332 = _loc4_.x;
               this.var_2253 = _loc4_.y;
               this.var_2255 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_148.z - _loc7_,this.var_106.z - _loc7_,this.var_85.z - _loc7_,this.var_107.z - _loc7_);
               this.var_2251 = _loc8_;
