package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1615:String = "cone";
      
      public static const const_1599:String = "plane";
      
      public static const const_1514:String = "sphere";
      ...
      private var var_867:Number = 0.1;
      
      private var var_1635:Number;
      
      private var var_242:Number;
      ...
      public function reset() : void
      {
         ...
         this.var_868 = 0;
         this.var_937 = false;
         this.init(0,0,0,this._direction,this.var_2221,this.var_867,this.var_2222,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1066.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_937 = true;
         if(this.var_868 < this.var_1320)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2223)
         {
            switch(this.var_2225)
            {
               case const_1615:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_867,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_331.push(_loc4_);
            ++this.var_868;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1066.length);
         return this.var_1066[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_868 < this.var_1320)
         {
            if(this.age % this.var_2224 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_868 < this.var_1320)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_242) * this.x - (1 - this.var_242) * this.lastX;
            this.y = (2 - this.var_242) * this.y - (1 - this.var_242) * this.lastY + this.var_1635 * this.var_867 * this.var_867;
            this.z = (2 - this.var_242) * this.z - (1 - this.var_242) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_331)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_242) * _loc2_.x - (1 - this.var_242) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_242) * _loc2_.y - (1 - this.var_242) * _loc2_.lastY + this.var_1635 * this.var_867 * this.var_867;
            _loc2_.z = (2 - this.var_242) * _loc2_.z - (1 - this.var_242) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_331.splice(this.var_331.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
