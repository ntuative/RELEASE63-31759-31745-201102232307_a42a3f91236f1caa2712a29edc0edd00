package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1238:int = 3;
      ...
      {
         return param1 + param2 * const_1238;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_140,const_72,const_63,const_140,const_72,const_63];
                     _loc8_ = [const_72,const_72,const_72,const_63,const_63,const_63];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
