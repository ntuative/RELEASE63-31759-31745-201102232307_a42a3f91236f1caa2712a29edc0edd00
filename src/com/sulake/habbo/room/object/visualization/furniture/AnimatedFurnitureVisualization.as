package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_310:AnimatedFurnitureVisualizationData = null;
      
      private var _state:int = -1;
      
      private var var_117:AnimationStateData;
      ...
      {
         super();
         this.var_117 = new AnimationStateData();
      }
      ...
      {
         return this.var_117.animationId;
      }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_310 = param1 as AnimatedFurnitureVisualizationData;
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1875)
                     {
                        this.var_1875 = _loc4_;
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_117,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this.var_310.isImmediateChange(this.var_968,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this.var_310.hasAnimation(this.var_968,_loc6_))
                  {
      ...
      {
         return this.var_117.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_117 != null)
         {
            this.var_117.setLayerCount(this.var_610);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_968 = param1;
            this.var_610 = this.var_310.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_117.animationOver)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_117,param1);
            if(this.var_117.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_117.animationId) || AnimationData.isTransitionToAnimation(this.var_117.animationId))
               {
                  this.setAnimation(this.var_117.animationAfterTransitionId);
                  this.var_117.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_310.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_610 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_995)
                  {
                     _loc10_ = this.var_310.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_310.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_545)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_117.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_117.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
