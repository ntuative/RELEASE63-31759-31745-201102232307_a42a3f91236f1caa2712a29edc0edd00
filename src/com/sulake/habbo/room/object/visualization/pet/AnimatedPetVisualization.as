package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_931:int = 1000;
      
      private static const const_1288:String = "pet_experience_bubble_png";
      
      private static const const_1287:int = 0;
      ...
      private var var_310:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_310 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_310.commonAssets != null)
         {
            _loc3_ = this.var_310.commonAssets.getAssetByName(const_1288) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_334);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_267);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_394) > 0;
            this.var_1609 = _loc3_.getNumber(RoomObjectVariableEnum.const_279);
            this.var_1341 = _loc3_.getNumber(RoomObjectVariableEnum.const_722);
            this.var_2003 = _loc3_.getNumber(RoomObjectVariableEnum.const_884);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1732)
            {
               this.var_1732 = _loc6_;
               this.var_2387 = this.var_1732.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1341 > 0)
            {
               _loc2_ = param1 - this.var_1341;
               if(_loc2_ < const_931)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_931 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_236)
         {
            this.var_236 = param1;
            _loc3_ = this.var_310.getAnimationForPosture(var_184,param1);
            this.setAnimationForIndex(const_1287,_loc3_);
         }
         if(param2 != this.var_1299)
         {
            this.var_1299 = param2;
            _loc3_ = this.var_310.getAnimationForGesture(var_184,param2);
            this.setAnimationForIndex(const_1289,_loc3_);
         }
      }
      
      override protected function getAdditionalSpriteCount() : int
      {
         return super.getAdditionalSpriteCount() + const_590;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2387);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_590)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_590))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_483.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_483[param2];
               if(_loc4_ == 1)
               {
