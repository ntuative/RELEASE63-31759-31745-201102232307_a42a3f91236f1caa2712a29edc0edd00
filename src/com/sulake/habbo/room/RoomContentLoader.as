package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_835:String = "RCL_LOADER_READY";
      
      private static const const_329:String = "RCL_PUBLICROOM_";
      
      private static const const_1717:int = 0;
      ...
      private static const const_599:String = "wall_place_holder";
      
      private static const const_600:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_419;
      
      private static const const_601:String = "room";
      ...
      private var var_434:Map = null;
      
      private var var_366:Dictionary;
      
      private var var_638:Map = null;
      
      private var _wallItems:Dictionary;
      
      private var var_975:Map = null;
      
      private var var_435:Dictionary;
      
      private var var_976:Map = null;
      
      private var var_200:PublicRoomData = null;
      
      private var var_1461:Map = null;
      
      private var var_639:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2682 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2680 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2681 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2683 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_435[_loc3_] = _loc2_;
            this.var_975.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_366)
            {
               delete this.var_366[_loc1_];
            }
            this.var_366 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_784.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_434.add(_loc3_,_loc4_);
               if(this.var_366[_loc7_] == null)
               {
                  this.var_366[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_638.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_639.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_639.remove(_loc7_);
               this.var_639.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2679)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_835));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_200 != null && (this.var_200.type == param1 || this.var_200.hasWorldType(param1)))
         {
      ...
      {
         return [const_419,const_599,const_600,const_601,TILE_CURSOR,const_961];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_434.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_638.getValue(param1) as String;
      ...
      {
         return this.var_975.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_976[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_638.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_784.getValue(param1) != null)
         {
            return this.var_784.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_200 != null && this.var_200.hasWorldType(const_329 + param1))
         {
            return this.var_200.type;
         }
         return param1;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2683 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
               this.var_434[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_27:
               this.var_638[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_366[_loc4_] == null)
                     {
                        this.var_366[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_377,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1461.getValue(param1) != null)
         {
            this.var_200 = this.var_1461.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_882,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2682.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1580);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_435[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_377,_loc5_);
         }
         else
         {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_435[param1];
            this.var_976.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1461.add(param1,_loc4_);
         this.var_200 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_785.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_785.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_785.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_265 && _loc5_ != RoomObjectLogicEnum.const_178)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_497.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_329 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_329 + param1) == RoomObjectCategoryEnum.const_75)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_200.getWorldHeightScale(const_329 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_200 != null)
         {
            return this.var_200.getWorldScale(const_329 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_434.add(param1,param2);
      }
   }
}
