package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1979:String = "type_sound_machine";
      
      private const const_1691:String = "type_jukebox";
      
      private var var_598:HabboSoundManagerFlash10;
      
      private var _connection:IConnection;
      
      private var _events:IEventDispatcher;
      
      private var var_77:IEventDispatcher;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_816,this.onSongFinishedPlayingEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_793,this.onSoundMachinePlayEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_698,this.onSoundMachineStopEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_828,this.onJukeboxInitEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_469,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_816,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_77)
            {
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_793,this.onSoundMachinePlayEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_698,this.onSoundMachineStopEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_828,this.onJukeboxInitEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_469,this.onDisposeEvent);
               this.var_77 = null;
            }
            if(this.var_403)
            {
      ...
      {
         this.startPlaying(this.const_1979);
      }
      ...
      {
         this.startPlaying(this.const_1691);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_292 = _loc2_.id;
            this.playSong(this.var_292);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_403[this.var_292] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_403.getValue(this.var_292) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         _loc2_.volume = this.var_598.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_598.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_292)
         {
      ...
      {
         if(this.var_1663 == this.const_1691)
         {
            this.var_76.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_583.indexOf(param1) == -1)
         {
            this.var_583.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_583 = this.var_583.splice(this.var_583.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_403[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_598.loadTraxSong(_loc3_.id,_loc3_.data);
