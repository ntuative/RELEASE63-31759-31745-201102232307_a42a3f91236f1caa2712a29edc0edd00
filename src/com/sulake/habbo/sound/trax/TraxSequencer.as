package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_272:uint = 8192;
      
      private static const const_1240:uint = 88200;
      
      private static const const_1239:uint = 88200;
      ...
      private var var_1290:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1593:TraxData;
      
      private var var_1596:Map;
      ...
      private var var_1595:uint;
      
      public function TraxSequencer(param1:int, param2:TraxData, param3:Map, param4:IEventDispatcher)
      {
         this.var_1595 = uint(const_272 / 44.1);
         super();
         this._events = param4;
         this.var_2028 = param1;
         this.var_478 = 1;
         this.var_1290 = new Sound();
         ...
         this._length = 0;
         this.var_1291 = false;
         this.var_100 = new Vector.<Number>(const_272,true);
      }
      
      public function set position(param1:Number) : void
      {
         this.var_208 = uint(param1 * 44100);
      }
      ...
      public function play() : Boolean
      {
         ...
         this.var_1291 = false;
         this.var_1290.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1290.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1290.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      {
         return Math.ceil(param1 / const_1240);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1593.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1593.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1596.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            _loc12_ = 0;
            while(_loc12_ < _loc2_[_loc7_].length && _loc2_[_loc7_][_loc12_] < this.var_208)
            {
               _loc12_++;
            }
            if(_loc12_ > 0)
            ...
            _loc14_ = this.var_208 - _loc2_[_loc7_][_loc12_];
            if(_loc13_ == null)
            {
               _loc3_.push(null);
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc17_ = const_272;
            if(this._length - this.var_208 < _loc17_)
            {
               _loc17_ = this._length - this.var_208;
            }
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
               ...
               {
                  if(_loc17_ + this.var_208 >= _loc15_[_loc16_ + 1])
                  {
                     _loc19_ = _loc15_[_loc16_ + 1] - this.var_208;
                  }
               }
         ...
         var _loc8_:* = 0;
         var _loc9_:int = const_272;
         if(this._length - this.var_208 < _loc9_)
         {
            _loc9_ = this._length - this.var_208;
            if(_loc9_ < 0)
            {
               _loc9_ = 0;
            }
         ...
         this.var_208 += const_272;
         if(this._soundChannel != null)
         {
            this.var_1595 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_208 > this._length + this.var_1595 * 44.1)
         {
            this.var_1291 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_816,this.var_2028));
      }
   }
}
