package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1830:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_94.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1830 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      private function localize() : void
      {
         ...
         {
            _loc33_ = this.var_94.roomItemTypeName.split("*");
            _loc34_ = _loc33_.length > 0 ? _loc33_[0] : "";
            _loc35_ = _loc33_.length > 1 ? int(parseInt(_loc33_[1])) : 0;
            _loc36_ = this.var_64.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc34_,_loc35_);
            if(_loc36_)
            {
               _loc38_ = "";
               _loc37_ = this.var_64.controller.questEngine.roomEngine.getFurnitureImage(_loc36_.id,new Vector3d(90,0,0),64,this,_loc35_,_loc38_);
               this.var_1829 = _loc37_.id;
               if(_loc37_ && _loc37_.data)
               {
                  this.imageReady(_loc37_.id,_loc37_.data);
               }
               this.var_64.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc36_.title);
            }
         }
