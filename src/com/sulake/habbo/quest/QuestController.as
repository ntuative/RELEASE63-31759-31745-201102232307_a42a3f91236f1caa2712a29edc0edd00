package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_187:HabboQuestEngine;
      
      private var var_143:Map;
      
      private var var_279:QuestCampaign;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_143)
         {
            for each(_loc1_ in this.var_143)
            {
               _loc1_.dispose();
            }
      ...
      {
         var _loc3_:QuestCampaign = this.var_143[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_143[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_187.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_584 != MODE_TABS)
         {
            this.var_584 = MODE_NO_TABS;
         }
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_143[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_143[param1] = _loc4_;
         }
         _loc4_.activityPointType = param2;
         this.var_279 = _loc4_;
         this.var_279.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_584 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1027.addChild(this.var_279.window);
         var _loc1_:String = "quest_" + this.var_279.code;
      ...
      private function updateTabs() : void
      {
         ...
         if(this.var_279)
         {
            _loc1_ = this.var_279.code;
         }
         else if(this.var_143.getKeys().length > 0)
         {
            _loc1_ = this.var_143.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_187.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1027 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_143.getKeys())
         {
            _loc3_ = this.var_143[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc2_ = this.var_187.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_426) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_187.getQuestCampaign(param2.caption);
      }
   }
}
