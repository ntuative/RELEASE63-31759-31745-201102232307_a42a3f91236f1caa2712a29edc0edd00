package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_968:int = 100;
      
      private static const const_1361:int = 20;
       
      
      private var var_128:HabboMessenger;
      
      private var var_2693:IScrollbarWindow;
      
      private var var_1924:IContainerButtonWindow;
      
      private var var_58:IItemListWindow;
      
      private var var_523:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_128 = param1;
         this.var_1924 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_58 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2693 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_968 + const_1361)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1362;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_523 == null || _loc1_.id != this.var_523.id)
         {
            this.var_523 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_523.followingAllowed)
         {
            this.var_1924.enable();
         }
         else
         {
            this.var_1924.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_58.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_523.messages.length - const_968);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_523.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_523.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_781 || param3.type == Message.const_836 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_523.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_128.send(new FollowFriendMessageComposer(this.var_523.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_851)
         {
            return 4293454056;
         }
         if(param1 == Message.const_733)
         {
            return 4293454056;
         }
         if(param1 == Message.const_986)
         {
            return 4288269465;
         }
         return 4291611852;
