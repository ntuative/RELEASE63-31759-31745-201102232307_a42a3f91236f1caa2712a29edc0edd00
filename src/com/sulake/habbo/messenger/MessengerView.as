package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_840:ITextFieldWindow;
      ...
      private function prepareContent() : void
      {
         ...
         this.var_841 = new ConversationsTabView(this.var_128,this.var_16);
         this.var_841.refresh();
         this.var_840 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_840.addEventListener(WindowKeyboardEvent.const_195,this.onMessageInput);
         this.var_1283 = new ConversationView(this.var_128,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_706,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1088,true);
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_840.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_840.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_840.text;
         ...
         this.var_840.text = "";
         this.var_128.conversations.addMessageAndUpdateView(new Message(Message.const_781,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
