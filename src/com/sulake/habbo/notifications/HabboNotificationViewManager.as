package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_939:int = 32;
      
      private static const const_1310:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2482,this.var_416,this.var_181,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_845 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_939;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_221.length)
         {
            _loc3_ = this.var_221[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_845 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_845 + const_1310;
            _loc2_++;
         }
         return _loc1_;
      }
