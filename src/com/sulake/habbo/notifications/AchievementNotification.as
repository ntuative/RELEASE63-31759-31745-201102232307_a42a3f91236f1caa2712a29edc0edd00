package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1693:String = "badge_bg_001_png";
      
      private const const_1982:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         param13.events.addEventListener(BadgeImageReadyEvent.const_147,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2306 = this.var_79.getBadgeName(this.var_293);
         this.var_2308 = this.var_79.getBadgeDesc(this.var_293);
         this.var_2303 = this.var_79.getAchievementNameForFacebook(this.var_293,this.var_404.userName,this.var_404.realName,this.var_1348);
         this.var_2304 = this.var_79.getAchievementDescForFacebook(this.var_293,this.var_404.userName,this.var_404.realName,this.var_1348);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2307 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_79.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1661.toString());
         this.var_79.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1347.toString());
         this.var_79.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1347.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1676;
         var _loc17_:String = this.var_1676 == 0 ? "pixels" : "activitypoints";
         this.var_79.registerParameter(_loc16_,_loc17_,"" + this.var_2162);
         _loc15_.caption = this.var_79.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1693);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1982) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1347 <= 0 || !_loc21_)
         {
            ...
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_293,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_293,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_293,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_79.registerParameter(param1,"badge_name",this.var_2306);
         this.var_79.registerParameter(param1,"badge_desc",this.var_2308);
         this.var_79.registerParameter(param1,"badge_name_fb",this.var_2303);
         this.var_79.registerParameter(param1,"badge_desc_fb",this.var_2304);
         this.var_79.registerParameter(param1,"level",this.var_1348.toString());
         this.var_79.registerParameter(param1,"name",this.var_404.userName);
         return this.var_79.registerParameter(param1,"realname",this.var_404.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_404.events.removeEventListener(BadgeImageReadyEvent.const_147,this.onBadgeImageReady);
            this.var_404 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_293)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1693);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_293,this._feedTitleFb,this.var_2307,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2305));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_293,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_293,"client.skip_post"));
               this.dispose();
               return;
         }
      }
