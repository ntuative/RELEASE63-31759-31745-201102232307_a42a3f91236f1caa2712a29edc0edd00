package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      private var var_660:ChargeInfo;
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_660);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_660.charges);
         var _loc2_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,new ChargeOffer(this.var_660));
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_660.chargePatchSize);
      ...
      private function onCharge(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_660.stuffId,2));
      }
