package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1972:int = 10;
      ...
      private const const_1699:uint = 4.293848814E9;
      
      private const const_1698:uint = 4.294967295E9;
      
      private const const_1973:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1618 = _loc1_.stuffTypes;
            this.var_692 = _loc1_.boxTypes;
            this.var_691 = _loc1_.ribbonTypes;
            this.var_1058 = this.var_1618[0];
            this.var_327 = this.var_692[0];
            this.var_329 = this.var_691[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_329 < 0)
         {
            this.var_329 = this.var_691.length - 1;
         }
         if(this.var_329 > this.var_691.length - 1)
         {
            this.var_329 = 0;
         }
         if(this.var_327 < 0)
         {
            this.var_327 = this.var_692.length - 1;
         }
         if(this.var_327 > this.var_692.length - 1)
         {
            this.var_327 = 0;
         }
         var _loc1_:int = this.var_692[this.var_327] * 1000 + this.var_691[this.var_329];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_89.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1058,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1305 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1618;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_89);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1058);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_692[this.var_327]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_691[this.var_329]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_89,this.var_1304,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_89.offerId,this.var_1304);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2214 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in this.var_205)
               {
                  ...
                  if(_loc5_.length >= this.const_1972)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2214 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_376:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_328 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_328 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_328) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_567 == null)
         {
            this.var_567 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_567.procedure = this.suggestionsEventHandler;
         }
         if(this.var_238 == null || this.var_567 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_567.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_328) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_328);
         }
         this.var_328 = param1;
         if(this.var_328 < 0)
         {
            this.var_328 = _loc2_.numListItems - 1;
         }
         if(this.var_328 >= _loc2_.numListItems)
         {
            this.var_328 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_328) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1973;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1699) : uint(this.const_1698);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1058;
               }
            }
            _loc4_++;
         }
