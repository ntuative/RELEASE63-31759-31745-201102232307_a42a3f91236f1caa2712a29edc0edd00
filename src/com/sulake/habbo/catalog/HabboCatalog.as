package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_345:ICatalogNavigator;
      
      private var var_98:Purse;
      
      private var var_91:RecyclerLogic;
      
      private var var_129:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_218:PurchaseConfirmationDialog;
      
      private var var_301:ChargeConfirmationDialog;
      ...
      private var var_2393:Boolean = true;
      ...
      private var var_1114:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_218 == null)
            {
               this.var_218 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_218.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_345.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_173.getKey("client.credits.embed.enabled","RoomWidgetCreditFurniUpdateEvent") == "HabboCatalogCom_productViewWidget";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_173.getKey("link.format.credits","/credits");
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_89)
         {
      ...
      {
         var _loc2_:Array = this.var_738.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_98.getActivityPointsForType(Purse.const_173)));
         var _loc1_:int = 0;
      ...
      {
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_741)
         {
            if(!this.var_404.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
         ...
         this.setupInventoryForRecycler(this.var_91.active && this._mainContainer.visible);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_345 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_227,false);
      ...
      private function method_6(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1742 = param1.session.isPrivateRoom;
               if(this.var_91 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_129 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1114 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_345.buildCatalogIndex(_loc2_);
         if(this.var_739 && this.var_739 != "")
         {
            this.var_345.openPage(this.var_739);
            this.var_739 = "";
            this.var_907 = -1;
         }
         else if(this.var_907 > -1)
         {
            this.var_345.openPageById(this.var_907,this.var_1741);
            this.var_907 = -1;
            this.var_1741 = -1;
            this.var_739 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2393 && this.var_598 != null)
         {
            this.var_598.playSound(HabboSoundTypesEnum.const_1189);
         }
         this.var_2393 = false;
         if(this.var_301 != null)
         {
            this.var_301.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_67,this.var_98.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2394 && this.var_598 != null)
         {
            this.var_598.playSound(HabboSoundTypesEnum.const_1054);
         }
         this.var_2394 = false;
         if(this.var_301 != null)
         {
         ...
         if(_loc2_.type == Purse.const_173)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1114.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_129 != null)
         {
            this.var_129.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_129 != null)
         {
            this.var_129.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_129 != null)
         {
            this.var_129.onCancelResult(param1);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_218 != null)
         {
            this.var_218.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_129.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_301 == null)
         {
            this.var_301 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_301.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_738.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_738.add(_loc2_.productCode,_loc3_.slice());
            this.var_302.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboCatalogCom_productViewWidget" == this.var_173.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_173.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_184)
         {
            _loc3_ = this.var_173.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
