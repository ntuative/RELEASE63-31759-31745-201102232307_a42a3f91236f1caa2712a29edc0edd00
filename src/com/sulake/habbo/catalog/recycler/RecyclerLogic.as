package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_937:int = 0;
      
      private static const const_414:int = 1;
      ...
      {
         return this.var_611 != const_937;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1792 != RecyclerStatusMessageEvent.const_1073;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_611 == const_414;
      }
      ...
      {
         this.var_611 = const_938;
         this.var_113 = new Array(const_187);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1792)
         {
            case RecyclerStatusMessageEvent.const_1392:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1073:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1377:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_975:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1473:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_187)
         {
            return false;
         }
         var _loc1_:int = 0;
