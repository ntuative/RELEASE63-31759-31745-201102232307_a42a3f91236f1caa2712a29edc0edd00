package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1662:String = "ctlg_";
       
      
      protected var var_1975:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1113:ICatalogViewer;
      ...
      private var var_457:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1025:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_457 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1026);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1026);
      }
      ...
      {
         var _loc2_:String = const_1662 + param1;
         ...
         this.var_1975 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1975) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1642:
               if(this.var_1025 == null)
               {
                  this.var_1025 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1025);
               }
               break;
            case CatalogWidgetEnum.const_1434:
               this.var_47.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1585:
               this.var_47.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1465:
            ...
            case CatalogWidgetEnum.const_1523:
               ...
               break;
            case CatalogWidgetEnum.const_1366:
            ...
            case CatalogWidgetEnum.const_1490:
               ...
               break;
            case CatalogWidgetEnum.const_1382:
               this.var_47.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1388:
            ...
            case CatalogWidgetEnum.const_1556:
               ...
               break;
            case CatalogWidgetEnum.const_1373:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_457.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_457 != null)
         {
            return this.var_457.dispatchEvent(param1);
         }
         return false;
      }
   }
