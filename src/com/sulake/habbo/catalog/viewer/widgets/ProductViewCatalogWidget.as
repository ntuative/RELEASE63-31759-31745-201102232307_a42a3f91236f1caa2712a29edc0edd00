package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_889 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1095 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1674 = new Point(this.var_86.x,this.var_86.y);
         this.var_482 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1346 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1673 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_889.text = _loc4_;
         this.var_1095.text = _loc5_;
         this.var_889.height = this.var_889.textHeight + 5;
         this.var_1095.y = this.var_889.y + this.var_889.height;
         this.var_1095.height = Math.max(130,this.var_1095.textHeight + 5);
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_211:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_55);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_50,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_276,AvatarAction.const_549);
                              _loc16_.appendAction(AvatarAction.const_274,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2302)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2302 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1674.x;
            this.var_86.y = this.var_1674.y;
            if(param3 != null)
            {
