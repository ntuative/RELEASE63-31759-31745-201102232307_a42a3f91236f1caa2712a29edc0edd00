   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_611,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_311,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_889,this.deActivateScrollbar);
      ...
      override public function init() : Boolean
      {
         ...
         this.var_992 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_838 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_838 >= 0 && this.var_838 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_838];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_577)
         {
            ++this.var_1582;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1582);
         }
      }
