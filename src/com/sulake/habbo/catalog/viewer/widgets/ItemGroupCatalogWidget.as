package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_606[this.var_1137][this.var_1770];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1137 = var_992.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1137];
         var _loc3_:Array = this.var_606[this.var_1137] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1770 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1770] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_502 || _loc1_.pricingModel == Offer.const_509)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_81 || _loc3_.productType == ProductTypeEnum.const_89)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_606.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_606[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in this.var_606)
         {
