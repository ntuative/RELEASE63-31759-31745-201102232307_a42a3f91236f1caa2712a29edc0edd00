package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_962.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_962 = null;
         }
         if(this.var_961 != null)
         {
            this.var_961.removeEventListener(WindowKeyboardEvent.const_195,this.windowKeyEventProcessor);
            this.var_961 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_962 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_962 != null)
         {
            this.var_962.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_961 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_961 != null)
         {
            this.var_961.addEventListener(WindowKeyboardEvent.const_195,this.windowKeyEventProcessor);
         }
         return true;
      }
