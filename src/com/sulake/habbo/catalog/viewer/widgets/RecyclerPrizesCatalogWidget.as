package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1113:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1739:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1113 = new PrizeViewer();
         this.var_737 = this.recycler.getPrizeTable();
         ...
         this.var_1740 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_737.length > 0 && this.var_737[0].prizes.length > 0)
         {
            this.select(this.var_737[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_737.length)
         {
            this.createLevelItem(this.var_737[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1740) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1739) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1113.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
