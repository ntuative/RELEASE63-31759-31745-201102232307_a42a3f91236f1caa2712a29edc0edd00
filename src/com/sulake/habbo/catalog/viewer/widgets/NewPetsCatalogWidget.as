package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1334:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_107,this.onTextWindowEvent);
         ...
         this.var_509 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_509 < 8)
         {
            return false;
         }
         this.var_2597 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_199 != null && this.var_199.length > 0)
         {
            this.var_361 = this.var_199[0];
         }
         else
         {
            this.var_361 = -1;
         }
         this._offers.add(this.var_509,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_199 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1334 && _loc2_ < this.var_199.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_509,this.var_199[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_199 != null && this.var_199.length > 0)
         {
            ...
            this.var_361 = this.var_199[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_509,this.var_361),this.getRaceLocalizationKey(this.var_509,this.var_361));
            }
         }
         return this.getRaceLocalizationKey(this.var_509,this.var_361);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_361 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_509;
         var _loc3_:int = this.var_361;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_361 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
