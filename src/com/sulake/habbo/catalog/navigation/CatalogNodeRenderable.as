package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1339:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1455:XML;
      
      private static var var_1457:XML;
       
      
      private var var_1894:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2784:IWindowContainer;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_58);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_58);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1894 == 4294967295)
            {
               this.var_1894 = _loc1_.color;
            }
            _loc1_.color = const_1339;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1476;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1581;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_58);
            }
         }
         if(this.var_58 != null)
         {
            this.var_58.visible = true;
            this.var_58.height = this.var_58.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_58);
            }
         }
         if(this.var_58 != null)
         {
            this.var_58.height = 0;
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1457) as IItemListWindow;
         if(this.var_58 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1455) as IWindowContainer;
         }
         else
         {
