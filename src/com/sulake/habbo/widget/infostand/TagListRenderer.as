package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1976:int = 5;
      
      private const const_1977:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1072 += param1.height + this.const_1977;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1072);
         this._offsetX += param1.width + this.const_1976;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1328 != null && this.var_1328.indexOf(param1) != -1)
         {
