package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_399:IFrameWindow;
      ...
      private const const_1975:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_333 = new Timer(this.const_1975);
         this.var_333.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc4_:ITextWindow = this.var_38.findChildByName("pet_name") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.text = param2;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_38.findChildByName("avatar_image") as IBitmapWrapperWindow;
         if(_loc5_ != null)
         {
            if(param3 != null)
            {
         ...
         var _loc6_:CommandConfiguration = this.var_1071.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_475);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1071.getValue(this.var_475) as CommandConfiguration;
      ...
      {
         this.var_1071.remove(param1);
         this.var_1071.add(param1,param2);
         if(param1 != this.var_475)
         {
            return;
         }
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_38 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_38 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_38.setParamFlag(WindowParam.const_93,true);
         this.var_38.context.getDesktopWindow().addEventListener(WindowEvent.const_48,this.onWindowDesktopResized);
         this.var_38.procedure = this.onCommandWindowProcedure;
         this.var_38.x = 80;
      }
      ...
      private function updateCommandButtonsViewState(param1:CommandConfiguration) : void
      {
         ...
         var _loc2_:IWindowContainer = IWindowContainer(this.var_38.findChildByName("commands_container"));
         hideChildren(_loc2_);
         ...
         this.var_38.height = _loc2_.height + 160;
         this.var_333.stop();
      }
      ...
      private function disableAllButtons() : void
      {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_38.findChildByName("commands_container"));
         var _loc2_:int = 0;
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_399 == null)
         {
            ...
            this.var_399 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_399 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_399.x = 200;
            this.var_399.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_399.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_395,this.var_475));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_456,this.var_475,this.var_1640 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_456,this.var_475,this.var_1640 + " " + _loc5_);
      ...
      private function onWindowDesktopResized(param1:WindowEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_38 && !this.var_38.disposed)
         {
            _loc2_ = param1.window;
            _loc3_ = new Rectangle();
            this.var_38.getGlobalRectangle(_loc3_);
            if(_loc3_.x > _loc2_.width)
            {
               this.var_38.x = _loc2_.width - this.var_38.width;
               this.var_38.getGlobalRectangle(_loc3_);
            }
