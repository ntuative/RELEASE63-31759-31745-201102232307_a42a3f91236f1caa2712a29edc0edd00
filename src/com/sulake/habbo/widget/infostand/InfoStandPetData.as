package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1700 = param1.id;
         this._type = param1.petType;
         this.var_2297 = param1.petRace;
         this.var_44 = param1.image;
         this.var_1996 = param1.isOwnPet;
         this.var_2004 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1348 = param1.level;
         this.var_2002 = param1.levelMax;
         this.var_2003 = param1.experience;
         this.var_1999 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_1998 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_1997 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2001 = param1.roomIndex;
         this.var_456 = param1.age;
      }
   }
}
