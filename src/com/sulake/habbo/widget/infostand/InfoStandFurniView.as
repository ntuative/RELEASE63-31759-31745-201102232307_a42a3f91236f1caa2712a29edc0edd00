package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_934 = this.var_188.findChildByTag("catalog");
         if(this.var_934 != null)
         {
            this.var_934.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_934);
            }
            this.var_934.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_934);
         }
      }
   }
}
