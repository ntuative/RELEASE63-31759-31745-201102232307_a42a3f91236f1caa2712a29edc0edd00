package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_140:IFrameWindow;
      
      private var var_543:IWindow;
      
      private var var_188:IBorderWindow;
      
      private var var_1117:TagListRenderer;
      
      private var var_121:IBorderWindow;
      
      private var var_2048:int;
      
      private const const_905:int = 5;
      
      private const const_1676:int = 39;
      
      private const const_1675:int = 7829367;
      
      private const const_1677:int = 16777215;
      
      private const const_1957:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1117 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_48,this.onButtonResized);
         }
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_188.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_188.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_188.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_188.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_905;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1675;
            }
            else
            {
               _loc3_.textColor = this.const_1677;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_905;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_376,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_376,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1117.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_992:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1217:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2048 > this.const_1957 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
         ...
         {
            _loc2_.textColor = this.const_1675;
            if(_loc3_.length >= this.const_1676)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1676 - 1);
            }
         }
      }
      ...
      {
         this.var_140 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_140.center();
         this.var_140.procedure = this.badgesEventProc;
         this.var_140.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_140 && this.var_140.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_543 = null;
         var _loc2_:IItemGridWindow = this.var_140.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_140.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_140.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_543);
               }
               if(_loc3_ <= -1)
               {
                  return;
