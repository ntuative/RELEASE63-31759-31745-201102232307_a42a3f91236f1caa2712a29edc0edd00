package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_188:IBorderWindow;
      ...
      private const const_1969:int = 152;
      
      private const const_1970:int = 16;
      
      private const const_1226:int = 4;
      
      private const const_1965:uint = 14342874;
      
      private const const_1967:uint = 3815994;
      
      private const const_1961:uint = 2085362;
      
      private const const_1959:uint = 39616;
      
      private const const_1966:uint = 10513106;
      
      private const const_1958:uint = 8734654;
      
      private const const_1964:uint = 9094430;
      
      private const const_1963:uint = 6200576;
      
      private const const_1962:String = "happiness";
      
      private const const_1968:String = "experience";
      
      private const const_1960:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_188 == null || this.var_65 == null)
         {
            return;
         }
         ...
         this.var_188.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_188.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_188.width < this.var_65.width)
         {
            this.var_188.x = this._window.width - this.var_188.width;
            this.var_65.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1962,param1.nutrition,param1.nutritionMax,this.const_1959,this.const_1961);
         this.updateStateElement(this.const_1968,param1.experience,param1.experienceMax,this.const_1958,this.const_1966);
         this.updateStateElement(this.const_1960,param1.energy,param1.energyMax,this.const_1963,this.const_1964);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1969,this.const_1970,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1965);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1967);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1226,_loc7_.width - 2,_loc7_.height - 2 - this.const_1226);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1226);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_475) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_188 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_188 != null)
         {
            this.var_53 = this.var_188.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_188.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_188.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_188.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_188.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_188.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_48,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_189 && this.var_189.getPetId() == this.var_475)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1545,true);
