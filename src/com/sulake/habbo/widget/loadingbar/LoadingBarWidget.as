package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_480:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_480.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_480 = null;
         }
         if(this.var_44 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_321,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_321,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_480 == null)
         {
            this.var_480 = new Sprite();
            this.var_480.addChild(new Bitmap(this.var_44));
            this.var_480.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_480.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_44;
            }
         }
         _loc2_.setDisplayObject(this.var_480);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_321)
         {
            return;
         }
         if(this._window != null)
