package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1327:int = 9;
      
      private static const const_944:int = 10;
      
      private static const const_594:int = 25;
      
      private static const const_1328:int = 25;
      
      private static const const_946:int = 4000;
      
      private static const const_1325:int = 6000;
      
      private static const const_1324:int = 3;
      
      private static const const_1326:int = 1;
      
      private static const const_595:int = 8;
      
      private static const const_417:int = 0;
      
      private static const const_945:int = (const_595 + const_417) * const_108 + const_108;
      ...
      private var var_2549:int = 150;
      
      private var var_225:int = 171.0;
      
      private var var_945:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_40 = param1.createWindow("chat_container","",HabboWindowType.const_61,HabboWindowStyle.const_31,HabboWindowParam.const_42,new Rectangle(0,0,200,this.var_225 + RoomChatHistoryPulldown.const_80),null,0) as IWindowContainer;
         this.var_40.background = true;
         this.var_40.color = 33554431;
         this.var_40.tags.push("room_widget_chat");
         this.var_354 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1108,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,200,this.var_225),null,0) as IItemListWindow;
         this.var_40.addChild(this.var_354);
         this.var_115 = param1.createWindow("chat_active_content","",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_62,new Rectangle(0,0,200,this.var_225),null,0) as IWindowContainer;
         this.var_115.clipping = false;
         this.var_354.addListItem(this.var_115);
         this.var_27 = new RoomChatHistoryViewer(this,param1,this.var_40,param2);
         this.var_2548 = param4.getKey("site.url");
         this.var_2549 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1161 && this.var_1161 > 0)
         {
            this.var_1161 = -1;
            this.animationStart();
         }
         if(this.var_932)
         {
            _loc2_ = param1 / const_1328 * const_1324;
            if(_loc2_ + this.var_943 > this.var_945)
            {
               _loc2_ = this.var_945 - this.var_943;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_943 >= this.var_945)
            {
               this.var_945 = const_108;
               this.var_943 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1161 = getTimer() + const_946;
            }
         }
         if(this.var_27 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_864,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_302,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_719,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_864,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_302,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_719,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_778,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2548);
         _loc2_.define(param1);
         if(this.var_944 != 1)
         {
            _loc2_.senderX /= this.var_944;
         }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1824 == 0)
            {
               this.var_1824 = param1.scale;
            }
            else
            {
               this.var_944 = param1.scale / this.var_1824;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_762.x += param1.positionDelta.x / this.var_944;
            this.var_762.y += param1.positionDelta.y / this.var_944;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_354.width = this.var_40.width - this.var_27.scrollbarWidth;
            this.var_354.height = this.var_225;
            this.var_354.x = this.var_40.x;
            this.var_354.y = this.var_40.y;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_67.length > const_1326 || this.historyViewerActive() && this.var_67.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_945 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_67[0]);
            }
            else
            {
               this.var_945 = const_108;
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_595 + const_417 + 2)
               {
                  _loc1_.aboveLevels = const_595 + const_417 + 2;
               }
               this.var_763 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_417 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1325)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_762.x) * this.var_944;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_40.width / 2 - const_944;
         var _loc6_:Number = this.var_40.width / 2 + const_944 - this.var_27.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_108 - const_416;
            }
            else
            {
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2549)
         {
      ...
      {
         return "chat_" + this.var_2550.toString() + "_item_" + (this.var_2547++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_381,param1,param3);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_40.height = this.var_225 + RoomChatHistoryPulldown.const_80;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_40.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_225 = const_945 + const_416;
         this.var_40.height = this.var_225 + this.var_27.pulldownBarHeight;
         this.var_354.width = this.var_40.width - this.var_27.scrollbarWidth;
         this.var_354.height = this.var_225;
         this.var_115.width = this.var_40.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_115.height = this.getTotalContentHeight() + const_416;
         }
         else
         {
            this.var_115.height = this.var_225;
         }
         this.var_354.scrollV = 1;
         if(!this.historyViewerActive())
         {
            this.var_27.containerResized(this.var_40.rectangle);
         }
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1057)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(this.var_1825 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1825 = false;
         }
