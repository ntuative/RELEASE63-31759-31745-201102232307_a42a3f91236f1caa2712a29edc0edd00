package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1266:int = 18;
      ...
      private var var_401:Number = -1;
      
      private var var_48:IScrollbarWindow;
      
      private var var_579:Number = 1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_174.state = RoomChatHistoryPulldown.const_232;
         ...
         this.var_48 = param2.createWindow("chatscroller","",HabboWindowType.const_1195,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_174.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_232);
      }
      ...
      {
         return !!this.var_402 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_174.state == RoomChatHistoryPulldown.const_401 || this.var_174.state == RoomChatHistoryPulldown.const_464;
      }
      ...
      {
         if(!this.var_402 && !this.var_1811)
         {
            this.var_402 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_174.state = RoomChatHistoryPulldown.const_401;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_48 != null)
         {
            ...
            if(param2)
            {
               this.var_48.scrollV = this.var_579;
            }
         }
         if(this.var_174 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_401 > 0 && param2)
         {
            if(this.var_1652)
            {
               if(Math.abs(param1 - this.var_401) <= const_1057)
               {
                  return;
               }
               this.var_1652 = false;
            ...
            if(this.var_402)
            {
               ...
               _loc5_ = (param1 - this.var_401) / this.var_48.height;
               _loc3_ = this.var_579 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_401;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_48.scrollV < 1 - const_1266 / this.var_48.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1653)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_48 != null)
         {
            this.var_579 = this.var_48.scrollV;
         }
         if(this.var_48 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_579 - this.var_48.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
