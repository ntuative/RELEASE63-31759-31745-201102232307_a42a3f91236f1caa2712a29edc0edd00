package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_132,this.showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.include,this.showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_149,this.showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_132,this.showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.include,this.showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_149,this.showPollContent);
      }
