package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1555:String = "POLL_OFFER_STATE_OK";
      
      public static const const_812:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_512:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     this._state = const_1555;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_668,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_812;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_440,this._id));
