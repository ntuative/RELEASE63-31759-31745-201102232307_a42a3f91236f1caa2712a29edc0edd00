package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1329:int = 11;
      
      private static const const_597:int = 18;
      
      private static const const_950:int = 16;
      
      private static const const_1330:int = 20;
      ...
      private var var_280:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1165 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2572 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_358 = new Timer(1000,1);
         this.var_358.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_419 = new Timer(10000,1);
         this.var_419.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_358.reset();
            this.var_358.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_358 = null;
         }
         if(this.var_419 != null)
         {
            this.var_419.reset();
            this.var_419.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_419 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_195,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_107,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_355,this.onWindowMoved);
         this.var_1831 = true;
         this.var_505 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_597 + const_950;
         _loc1_.x = const_597;
         _loc1_.y = const_1329;
      }
      ...
      {
         this.var_280 = param1 - (const_597 + const_950);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1165 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_505 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1330);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_505.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_505 = _loc2_.text;
            if(!this.var_623)
            {
               this.var_623 = true;
               this.var_358.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_623);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_280)
         {
