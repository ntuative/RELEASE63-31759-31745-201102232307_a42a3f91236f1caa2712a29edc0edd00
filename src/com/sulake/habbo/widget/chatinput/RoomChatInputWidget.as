package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_859,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_810,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_133,this.onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_776,this.onSettings);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_681,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_810,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_776,this.onSettings);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_133,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_681,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1002:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1515:
         }
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         this.var_2339 = param1.allowPaste;
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_875,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_722 = this.var_722 - 1;
            this._visualization.showFloodBlocking(this.var_722);
         }
      }
      ...
      {
         this.var_1363 = true;
         this.var_722 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_722 + " seconds");
         if(this.var_721)
         {
            this.var_721.reset();
         }
         ...
         {
            this.var_721 = new Timer(1000,this.var_722);
