package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1708:int = 3;
      ...
      private const const_2004:int = 4;
      
      private const const_1999:int = 5;
      
      private const const_1711:String = "deco_img";
      
      private const const_1707:String = "dialog_bg";
      
      private const const_2005:String = "%campaign%_dialog_bg.png";
      
      private const const_328:String = "%campaign%_gift_package.png";
      
      private const const_2003:String = "%campaign%_gift_content.png";
      
      private const const_2001:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this._imageUrlPath = this.var_153.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1444.length)
         {
            _loc2_ = this.var_1444.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_153 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_544,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_849,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_544,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_544:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_743:
               ...
               this._shareId = null;
               this.var_1443 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_849:
               _loc2_ = this.const_1709;
               this.var_339 = param1.objectId;
         ...
         if(this._window && (this.var_1445 != _loc2_ || _loc3_ != this.var_180))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_180 = _loc3_;
         this.var_1445 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1445)
            {
               ...
               case this.const_1709:
                  if(this.var_379 == this.const_2002)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.locked");
                     _loc2_ = this.const_328;
                  }
                  else if(this.var_379 == this.const_2000)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.unlocked");
                     _loc2_ = this.const_2003;
                  }
                  else if(this.var_379 == this.const_1998)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.no_fb");
                     _loc3_ = var_79.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_79.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_328;
                  }
                  else if(this.var_379 == this.const_2006)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.not_enough_fb_friends");
                     _loc3_ = var_79.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_79.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_328;
                  }
                  else if(this.var_379 == this.const_2004)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_379 == this.const_1999)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_180,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_2005.replace("%campaign%",this.var_180);
            this.setDecoImage(_loc5_,this.const_1707);
            _loc2_ = _loc2_.replace("%campaign%",this.var_180);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_846);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_180,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_180,"client.start_post",this._shareId);
         var _loc4_:String = this.var_153.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_180,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1443 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1443 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
         this.sendConversionPoint("viral_" + this.var_180,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_644,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1444.push(new ImageDownloader(this,_assets,this.var_180,this._imageUrlPath,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1707:
      ...
      {
         if(!this._window || this.var_180 != param1.campaignID)
         {
            return;
         }
