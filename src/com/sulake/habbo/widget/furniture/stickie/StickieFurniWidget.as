package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1228:int = 14;
      
      private static const const_1229:int = 500;
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1768 = param1.objectType;
         this._text = param1.text;
         this.var_922 = param1.colorHex;
      ...
      private function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1223,const_1222,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_107,this.onTextWindowEvent);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1768 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_922);
            }
         ...
         this.setColorButtons(this._controller && this.var_1768 == "post_it");
      }
      ...
      private function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_433,this.var_339,this._text,this.var_922);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_433,this.var_339,this._text,this.var_922);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_642,this.var_339);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1229;
         if(_loc2_.numLines < const_1228)
         {
            return;
         }
