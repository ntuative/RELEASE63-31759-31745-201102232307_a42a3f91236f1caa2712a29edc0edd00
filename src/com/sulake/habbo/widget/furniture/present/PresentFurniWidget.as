package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1222:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_69,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_88,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_429,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_476,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_449,this.onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_69,this.onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_69,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_88,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_429,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_476,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_449,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_532,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_69,this.onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_69:
               this.hideInterface();
               this.var_338 = false;
            ...
            case RoomWidgetPresentDataUpdateEvent.const_476:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_449:
               if(!this.var_338)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_429:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_88:
               if(!this.var_338)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_69:
               this.hideInterface();
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1223,const_1222,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_338 || this.var_339 == -1 || !this._controller)
         {
            return;
         }
         this.var_338 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_161,this.var_339);
