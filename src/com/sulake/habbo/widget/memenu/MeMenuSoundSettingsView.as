package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_969:MeMenuSoundSettingsSlider;
      ...
      private var var_1879:BitmapData;
      ...
      {
         this.var_478 = param1.volume;
         if(this.var_969 != null)
         {
            this.var_969.setValue(this.var_478);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1878 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1880 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1877 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1879 = (_loc5_.content as BitmapData).clone();
         }
         this.var_969 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_899));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_478 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1878);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1880);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_478 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1877);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1879);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_620);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_624);
         }
