package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2778:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2778 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_353:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_79,this.var_153,this.var_2604++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_79,this);
               break;
            case RoomWidgetEnum.const_482:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_79,this.var_153,this._catalog);
               break;
            case RoomWidgetEnum.const_560:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_79,events,this.var_153);
               break;
            ...
            case RoomWidgetEnum.const_572:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_79,this.var_153,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_521:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_79,this.var_153);
               break;
            case RoomWidgetEnum.const_715:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_79,this.var_153);
               break;
            case RoomWidgetEnum.const_118:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_79,this.var_153);
               break;
