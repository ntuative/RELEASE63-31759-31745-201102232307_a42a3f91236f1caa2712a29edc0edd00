package com.sulake.core.assets
{
   ...
   public class FontAsset implements IAsset
   {
      ...
      protected var var_1630:AssetTypeDeclaration;
      
      protected var var_172:Font;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         try
         {
            if(unknown is Class)
            {
               this.var_172 = Font(FontEnum.registerFont(unknown as Class));
            }
         }
         catch(e:Error)
         {
      ...
      public function setFromOtherAsset(param1:IAsset) : void
      {
         ...
         {
            this.var_172 = FontAsset(param1).var_172;
            return;
         }
