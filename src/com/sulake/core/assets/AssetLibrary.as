package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1182:String = "AssetLibraryReady";
      
      public static const const_882:String = "AssetLibraryLoaded";
      
      public static const const_1574:String = "AssetLibraryUnloaded";
      
      public static const const_1517:String = "AssetLibraryLoadError";
      
      private static var var_303:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_489:uint = 0;
      
      private static var var_913:Array = new Array();
      ...
      private var var_602:Class;
      
      private var var_910:Dictionary;
      
      private var var_152:Dictionary;
      
      private var var_911:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_489;
         this.var_413 = new Dictionary(false);
         this.var_488 = new Dictionary(false);
         this.var_910 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_913.splice(var_913.indexOf(this),1);
            --var_489;
            this.var_488 = null;
            this.var_910 = null;
            this.var_152 = null;
      ...
      {
         if(this._file == param1.url && this.var_912)
         {
            if(!this.var_911 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_742,this.var_602);
            }
            this.var_911 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1182));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_488)
         {
            _loc2_ = this.var_488[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_488[_loc1_];
         }
         for(_loc1_ in this.var_152)
         {
            delete this.var_152[_loc1_];
         }
         for(_loc1_ in this.var_910)
         {
            delete this.var_910[_loc1_];
         }
         if(this.var_41 != null)
         {
            this.var_41.dispose();
         ...
         this.var_912 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1574));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_910[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_488[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1215,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1080,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1175,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1216,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_488[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_488[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_414;
                     this.var_412.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_488[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_412.length ? this.getAssetByName(this.var_412[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_152)
         {
            ...
            {
               return this.var_412.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_152[param1] != null || (this.var_602 != null ? this.var_602[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_413.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_413[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_413[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_413)
         {
            _loc3_ = AssetTypeDeclaration(this.var_413[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_413)
         {
            _loc4_ = AssetTypeDeclaration(this.var_413[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_742 = _loc2_.manifest.copy();
         this.var_602 = _loc2_.resource;
         ...
         this.var_912 = true;
         dispatchEvent(new Event(AssetLibrary.const_882));
         dispatchEvent(new Event(AssetLibrary.const_1182));
         if(this.var_911)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1517));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_742.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_602[param1]);
