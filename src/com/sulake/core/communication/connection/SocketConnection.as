package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1552:int = 10000;
      ...
      private var var_525:ByteArray;
      
      private var var_1216:IEncryption;
      
      private var var_790:IProtocol;
      
      private var _id:String;
      
      private var var_1217:IMessageClassManager;
      
      private var var_294:ICoreCommunicationManager;
      
      private var var_526:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_294 = param2;
         this.var_525 = new ByteArray();
         this.var_1217 = new MessageClassManager();
         this.var_81 = new Socket();
         this.var_373 = new Timer(const_1552,1);
         this.var_373.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_526)
         {
            this.var_526.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_373.start();
         this.var_791 = getTimer();
      ...
      {
         this.var_373.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_294.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1217.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_790.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_526)
         {
            this.var_526.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1216 != null)
         {
            _loc3_ = this.var_1216.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1217.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_790.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_790.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1216 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_790.getMessages(this.var_525,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_526)
               {
                  this.var_526.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1217.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_294.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_294.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_525,offset);
               this.var_525 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_525.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_525.writeByte(this.var_81.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_373.stop();
         this.var_1931 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_791));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1931 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_791));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_791));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_791));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_791));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_791));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_373.delay + " ms). Possible Firewall.";
