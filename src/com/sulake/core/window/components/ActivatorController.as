package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_244)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowNotifyEvent.const_848)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_799;
         if(this.var_799 != param1)
         {
            if(this.var_799 != null)
            {
               if(!this.var_799.disposed)
               {
                  this.var_799.deactivate();
               }
            }
            this.var_799 = param1;
