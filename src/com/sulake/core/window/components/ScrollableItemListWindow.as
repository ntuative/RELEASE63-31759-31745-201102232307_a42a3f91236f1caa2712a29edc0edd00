package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1063:IItemListWindow;
      
      private var var_397:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_76))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_397)
         {
            this.var_397.removeEventListener(WindowEvent.const_311,this.scrollBarEventProc);
            this.var_397.removeEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            this.var_397 = null;
         }
         if(this.var_1063)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1063)
         {
            this.var_1063 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_397)
         {
            this.var_397 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_397)
            {
               this.var_397.addEventListener(WindowEvent.const_311,this.scrollBarEventProc);
               this.var_397.addEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            }
         }
         return this.var_397;
      }
