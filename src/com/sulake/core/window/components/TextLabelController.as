package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_353:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_353);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2545 = _loc2_.textWidth;
         this.var_2544 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_353 != _loc2_.color : this.var_353 != null && this.var_353 != PropertyDefaults.const_646) ? new PropertyStruct(PropertyDefaults.const_339,this.var_353,PropertyStruct.const_146,true) : PropertyDefaults.const_1178);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_661)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,this.var_39.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_432);
            }
            if(this.var_39.top != PropertyDefaults.const_674)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,this.var_39.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_507);
            }
            if(this.var_39.right != PropertyDefaults.const_738)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,this.var_39.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_444);
            }
            if(this.var_39.bottom != PropertyDefaults.const_746)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,this.var_39.bottom,PropertyStruct.const_39,true));
            }
            else
            {
