package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1277:String = "_TITLE";
      
      private static const const_1276:String = "_HEADER";
      
      private static const const_1278:String = "_CONTENT";
      
      private static const const_1275:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1362:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1277) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1362 = findChildByTag(const_1276) as IHeaderWindow;
            if(!this.var_1362)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_172 = findChildByTag(const_1278) as IWindowContainer;
            if(!this.var_172)
            {
      ...
      {
         return findChildByTag(const_1275) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1218,_loc2_,false);
      ...
      {
         return this.content != null && this.var_998 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_310);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_224);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_270);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_309,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,_loc3_.left,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.top,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         }
         else
         {
