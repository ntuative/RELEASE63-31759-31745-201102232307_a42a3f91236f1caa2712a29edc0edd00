package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1297:String = "increment";
      
      private static const const_1296:String = "decrement";
      
      private static const const_934:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_165 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_506;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_17.removeEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_17.removeEventListener(WindowEvent.const_515,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_515,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_915 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_934) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_593:
               if(param2.type == WindowNotifyEvent.const_296)
               {
                  if(!this.var_1121)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_540)
         {
            if(this.var_17 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_566)
         {
            ...
            else if(param2.name == const_1296)
            {
               if(this.var_17)
               {
                  this.var_1121 = true;
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_915) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_915) as IScrollableWindow;
               if(_loc1_)
               {
