package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1219:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_807:Number;
      
      protected var var_534:Number;
      
      protected var var_535:Boolean;
      
      protected var var_39:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_120:Boolean = false;
      
      protected var var_995:Boolean = false;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_170);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_653 ? true : null;
         }
      ...
      {
         this.var_807 = param1;
         this._field.scrollH = this.var_807 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_534)
         {
            this.var_534 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_534)
         {
            this.var_534 = param1;
      ...
      {
         return new Rectangle(this.var_807 * this.maxScrollH,this.var_534 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1014) ? new PropertyStruct(PropertyDefaults.const_654,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1125) : PropertyDefaults.const_1439);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1186 ? new PropertyStruct(PropertyDefaults.const_731,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1183) : PropertyDefaults.const_1416);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_36,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_146,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_223,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1039 ? new PropertyStruct(PropertyDefaults.const_1185,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1084) : PropertyDefaults.const_1617);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_646) ? new PropertyStruct(PropertyDefaults.const_339,this._field.textColor,PropertyStruct.const_146,true) : PropertyDefaults.const_1178);
         _loc1_.push(this.var_432 != TextStyleManager.const_170 ? new PropertyStruct(PropertyDefaults.const_337,this.var_432,PropertyStruct.const_53,true,PropertyDefaults.const_712) : PropertyDefaults.const_976);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_661 ? new PropertyStruct(PropertyDefaults.const_247,this.var_39.left,PropertyStruct.const_39,true) : PropertyDefaults.const_432);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_674 ? new PropertyStruct(PropertyDefaults.const_246,this.var_39.top,PropertyStruct.const_39,true) : PropertyDefaults.const_507);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_738 ? new PropertyStruct(PropertyDefaults.const_256,this.var_39.right,PropertyStruct.const_39,true) : PropertyDefaults.const_444);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_746 ? new PropertyStruct(PropertyDefaults.const_226,this.var_39.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_468);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1163 ? new PropertyStruct(PropertyDefaults.const_659,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1592);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_252,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_252,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_252,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
