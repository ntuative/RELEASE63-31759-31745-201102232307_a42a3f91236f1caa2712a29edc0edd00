package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_409:String = "_DROPMENU_TITLETEXT";
      ...
      {
         if(param1 > this.var_234.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_438,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_559 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_340,this,null));
         }
      }
      ...
      {
         return getChildByName(DropMenuController.const_409) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_170 == null || this.var_170.disposed)
         {
            this.var_170 = context.create(name + "::submenu","",WindowType.const_475,var_83,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_234.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_850 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_850)
         {
            if(this.open())
            {
               if(this.var_234.length)
               {
                  this.populateMenuItemContainer(this.var_234,this.getSubMenu(),this.subMenuEventProc);
                  this.var_850 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_850 = false;
            this.getTitleLabel().text = this.var_559 < this.var_234.length && this.var_559 > -1 ? this.var_234[this.var_559] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_557,var_83,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_345,var_83,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_559 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_559).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_566)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1020:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_663:
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_234[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_234.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_862,this.var_234,PropertyStruct.const_154,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_862)
            {
