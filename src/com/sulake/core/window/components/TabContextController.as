package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1344:String = "_SELECTOR";
      
      private static const const_1343:String = "_CONTENT";
       
      
      protected var var_996:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_996 = findChildByTag(const_1344) as ITabSelectorWindow;
            if(this.var_996 != null)
            {
               this.var_996.procedure = this.selectorEventProc;
            }
         }
         return this.var_996;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1990 = findChildByTag(const_1343) as IWindowContainer;
         }
      ...
      {
         return !!this.var_741 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_996.numSelectables;
      }
