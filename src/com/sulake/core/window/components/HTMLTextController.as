package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_818:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_665:String;
      
      private var var_1017:String = null;
      
      private var var_1533:StyleSheet = null;
      ...
      {
         this.var_665 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1017 == param2)
         {
            return;
         }
         param1.var_1017 = param2;
         param1.var_1533 = null;
         if(param1.var_1017 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1017);
            param1.var_1533 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_809.indexOf(param1) > -1)
         {
            this.var_665 = param1;
         }
      }
      ...
      {
         return this.var_665 == LinkTarget.const_31 ? defaultLinkTarget : this.var_665;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1533;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_665 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_827,this.var_665,PropertyStruct.const_53,true,PropertyDefaults.const_809));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1461);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_665 = _loc2_.value as String;
               break;
            }
