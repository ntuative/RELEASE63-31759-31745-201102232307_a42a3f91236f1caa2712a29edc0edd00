package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1194,var_11);
         }
         return var_20;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_566)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_741 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_362,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_669,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1511);
         _loc1_.push(this.var_1236 != PropertyDefaults.const_1203 ? new PropertyStruct(PropertyDefaults.const_630,this.var_1236,PropertyStruct.const_36,true) : PropertyDefaults.const_1593);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1094 ? new PropertyStruct(PropertyDefaults.const_751,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1606);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1087 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1635);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_630:
                  this.var_1236 = _loc2_.value as Boolean;
                  if(this.var_1236)
                  {
