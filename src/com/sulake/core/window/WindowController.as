package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1218:String = "_COLORIZE";
      
      protected static const const_1666:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1417:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_749 = _loc13_.blend;
            var_443 = _loc13_.var_2729;
            if(var_442 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_228 != _loc13_.color)
            {
      ...
      {
         var_442 = param1;
         var_228 = !!var_442 ? uint(var_228 | var_532) : uint(var_228 & 16777215);
      ...
      {
         var_532 = param1 & 4278190080;
         var_228 = !!var_442 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      ...
      {
         var_532 = param1 << 24;
         var_228 = !!var_442 ? uint(var_532 | var_228) : uint(16777215 & var_228);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      
      public function set blend(param1:Number) : void
      {
         var_749 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_83 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_425,this,null));
         }
      }
      ...
      {
         var_443 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_540,this,this._parent));
            }
            else
            {
               this.var_352.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1027,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_764,var_11);
            this.var_20.visible = var_378;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_18,_context,var_11,null,this.var_653,this.properties,var_804.concat(),_id) as WindowController;
         ...
         _loc2_.var_228 = var_228;
         _loc2_.var_532 = var_532;
         _loc2_.var_803 = var_803;
         _loc2_.var_378 = var_378;
         _loc2_.var_749 = var_749;
         _loc2_.var_18 = var_18;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_19;
         _loc2_.background = var_442;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_100))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2543 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_65);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_555)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_434)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1168,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_648,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_443,this,null));
            }
            if(_loc6_)
            {
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_744))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1112;
                  if(testParamFlag(WindowParam.const_352))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_227))
                        {
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_310))
                        {
               ...
               case WindowMouseEvent.const_59:
                  ...
                  if(testParamFlag(WindowParam.const_227))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_189:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_180,WindowParam.const_162))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_176,WindowParam.const_159))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_18);
                        var_18 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_562))
                        {
               ...
               case WindowNotifyEvent.const_443:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_451);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1143,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_296,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_396:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_848,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_244,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_487:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1170);
                  break;
               case WindowNotifyEvent.const_425:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1666) == -1)
                     {
                        _loc8_.style = var_83;
                     }
                  }
               ...
               case WindowNotifyEvent.const_511:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_451);
                     }
                  }
                  else if(var_18 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_396:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1090:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1075:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1435:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1454:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_340:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_635:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1050:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1078:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_443);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_443);
      }
         ...
         if(this.var_165 && var_443 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1417,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1417,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_162);
         var _loc2_:* = !testParamFlag(WindowParam.const_150,WindowParam.const_159);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_180)
               {
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_407)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_360)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_492)
         {
            return true;
         }
         _state = WindowState.const_492;
         ...
         _loc1_.type = WindowNotifyEvent.const_1106;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1078,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1166,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1090,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1075;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_64,false);
         _loc1_.type = WindowNotifyEvent.const_1115;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_710;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1157 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_344,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1157 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_861,this,param1));
         return param1;
      }
