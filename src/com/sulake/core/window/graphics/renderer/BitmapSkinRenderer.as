package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_806:Dictionary;
      
      protected var var_805:Dictionary;
      ...
      {
         super(param1);
         this.var_806 = new Dictionary(false);
         this.var_805 = new Dictionary(false);
         this.var_973 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_973 = null;
            for(_loc1_ in this.var_806)
            {
               _loc2_ = this.var_806[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_806[_loc1_];
            }
            this.var_806 = null;
            for(_loc1_ in this.var_805)
            {
               _loc2_ = this.var_805[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_805[_loc1_];
            }
            this.var_805 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_441[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_303)
                  {
                     var_34.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_460)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_320)
                  {
                     _loc12_ = true;
                     var_34.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_303)
                  {
                     var_34.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_460)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_320)
                  {
                     _loc13_ = true;
                     var_34.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_320 || _loc10_.scaleH == SkinLayoutEntity.const_320)
                  {
                  ...
                  {
                     this.var_973.a = 0 / _loc17_.width;
                     this.var_973.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_973);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_973,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_806[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_805[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
