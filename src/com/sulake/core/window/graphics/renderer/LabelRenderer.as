package com.sulake.core.window.graphics.renderer
{
   ...
   public class LabelRenderer extends SkinRenderer
   {
      ...
      protected var var_994:Matrix;
      
      protected var var_2746:TextStyle;
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc7_ != this.var_2746)
            {
               this._cachedTextField = TextFieldCache.method_4(_loc7_);
               this.var_2746 = _loc7_;
            }
            this.var_994.tx = _loc6_.drawOffsetX;
            this.var_994.ty = _loc6_.drawOffsetY;
            ...
            BitmapData(param2).draw(this._cachedTextField,this.var_994,null,null,null,false);
