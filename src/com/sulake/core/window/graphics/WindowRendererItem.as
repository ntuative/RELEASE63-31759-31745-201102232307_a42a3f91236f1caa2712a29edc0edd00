package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_598:uint = 0;
      
      private static const const_952:uint = 1;
      
      private static const const_951:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1430 = 4294967295;
         this.var_955 = 0;
         this.var_1842 = new ColorTransform();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_951) : uint(const_598);
         var _loc6_:Boolean = this.var_179.width > 0 && this.var_179.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_955))
            {
               _loc5_ = const_952;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_952)
               {
                  ...
                  if(this.var_625)
                  {
                     ...
                     _loc7_.draw(param1,this.var_100,this.var_100.rect,this.var_955,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     this.var_1842.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_100,this.var_994,this.var_1842,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_892.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_201)
            {
               _loc2_ = this.var_892.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_201);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_892.getTheActualState(param1.type,param1.style,param1.state) != this.var_1430;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            case WindowRedrawFlag.const_65:
               this.var_625 = true;
               _loc4_ = true;
               break;
            ...
            case WindowRedrawFlag.const_1170:
               this.var_955 = this.var_892.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_955 != this.var_1430)
               {
                  this.var_625 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1176:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_625 = true;
                  _loc4_ = true;
