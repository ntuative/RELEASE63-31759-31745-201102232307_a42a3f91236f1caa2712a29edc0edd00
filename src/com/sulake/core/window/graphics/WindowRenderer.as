package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1502:Point;
      
      private var var_1246:Rectangle;
      
      private var var_273:Rectangle;
      
      private var var_892:ISkinContainer;
      
      private var var_317:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1246 = new Rectangle();
         this.var_273 = new Rectangle();
         this.var_317 = new Dictionary(true);
         this.var_892 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_654 = null;
            for(_loc1_ in this.var_317)
            {
               delete this.var_317[_loc1_];
            }
            this.var_317 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_273,WindowRedrawFlag.const_1209);
            if(this.var_654.indexOf(param1) == -1)
            {
               this.var_654.push(param1);
            }
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_65);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_317[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_317[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_892);
            this.var_317[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_883,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_883,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_317[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_317[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_654.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1502,this.var_1246))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1502,this.var_1246))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1246);
