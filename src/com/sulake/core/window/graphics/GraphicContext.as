package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_764:uint = 1;
      
      public static const const_1194:uint = 2;
      
      public static const const_657:uint = 4;
      
      public static const const_1425:uint = 8;
      
      public static const const_1529:uint = 16;
      
      public static const const_1753:uint = 64;
      
      public static const const_1888:uint = 128;
      
      public static const const_1210:uint = 256;
      
      protected static var var_537:uint = 0;
      
      protected static var var_316:uint = 0;
       
      
      protected var var_202:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1194:
               ...
               break;
            case GraphicContext.const_1425:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1529:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_657:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1210:
               break;
            case GraphicContext.const_1501:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_202.numChildren > 0)
               {
                  this.var_202.removeChildAt(0);
               }
            }
            this.var_202 = null;
            while(numChildren > 0)
         ...
         if(this.var_802)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_316 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1983,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1983,16777215);
                  }
                  var_316 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_802)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_316 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_202 == null)
         {
            this.var_202 = new Sprite();
            this.var_202.name = this.name + " - Child Container";
            this.var_202.mouseEnabled = false;
            addChild(this.var_202);
         }
         return this.var_202;
      }
      ...
      {
         return this.var_202 != null ? int(this.var_202.numChildren) : 0;
      }
