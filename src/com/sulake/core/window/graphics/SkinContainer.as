package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_913:uint = 8;
      
      private static const const_1236:String = "skin";
      
      private static const const_1235:String = "bitmap";
      
      private static const const_1233:String = "fill";
      
      private static const const_1232:String = "text";
      
      private static const const_1234:String = "label";
      ...
      private var var_2181:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2181 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1591,this.var_2181);
         this.var_2182 = new Dictionary();
         this.var_2180 = new Dictionary();
         StateCodeTable.fillTables(this.var_2182,this.var_2180);
         this.var_389 = new Dictionary();
         this.var_389[const_1236] = BitmapSkinRenderer;
         this.var_389[const_1235] = BitmapDataRenderer;
         this.var_389[const_1233] = FillSkinRenderer;
         this.var_389[const_1232] = TextSkinRenderer;
         this.var_389[const_1234] = LabelRenderer;
         this.var_389[const_1237] = ShapeSkinRenderer;
         this.var_389[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_389[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_315 == null)
         {
            var_315 = new Array();
            var_315.push(WindowState.const_64);
            var_315.push(WindowState.const_76);
            var_315.push(WindowState.const_85);
            var_315.push(WindowState.const_54);
            var_315.push(WindowState.const_91);
            var_315.push(WindowState.const_82);
            var_315.push(WindowState.const_100);
            var_315.push(WindowState.const_97);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2729 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboCatalogCom_productViewWidget" : false;
                  ...
                  this.addSkinRenderer(this.var_1591[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_848[param1] == null)
         {
            this.var_848[param1] = new Array(const_913);
         }
         this.var_848[param1][param2] = param3;
         if(this.var_849[param1] == null)
         {
            this.var_849[param1] = new Array(const_913);
         }
         this.var_849[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_848[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_849[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_201)
