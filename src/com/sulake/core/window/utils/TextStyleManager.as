package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_170:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_84:Map;
      
      private static var var_474:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_588:String = "{";
      
      private static const const_589:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_170],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_170] = _loc5_[0];
            var_84[ITALIC] = _loc5_[1];
            var_84[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_84[_loc4_.name] = _loc4_;
            if(var_474.indexOf(_loc4_.name) == -1)
            {
               var_474.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_84.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_84.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboCatalogCom_productViewWidget" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_589);
         if(countSubStrings(param1,const_588) != countSubStrings(param1,const_589))
         {
            throw new Error("Mismatching amount of \"" + const_588 + "\" versus \"" + const_589 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1257) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1256) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_588)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
