package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_797:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_174;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_135 = param1.desktop;
         this.var_82 = param1.var_1218 as WindowController;
         this._lastClickTarget = param1.var_1219 as WindowController;
         this.var_151 = param1.renderer;
         this.var_797 = param1.var_1221;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_647.x || _loc3_.stageY != this.var_647.y)
            {
               this.var_647.x = _loc3_.stageX;
               this.var_647.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_135.groupParameterFilteredChildrenUnderPoint(this.var_647,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_82 != this.var_135 && !this.var_82.disposed)
                  {
                     ...
                     this.var_82 = WindowController(this.var_135);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_82 && !this.var_82.disposed)
                     {
                        ...
                        {
                           this.var_797.mouseEventReceived(_loc3_.type,this.var_82);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_135;
         param1.var_1218 = this.var_82;
         param1.var_1219 = this._lastClickTarget;
         param1.renderer = this.var_151;
         param1.var_1221 = this.var_797;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_527))
         {
