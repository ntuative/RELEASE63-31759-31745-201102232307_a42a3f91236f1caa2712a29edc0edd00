package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_985:Map = new Map();
      ...
      public static function method_4(param1:TextStyle) : TextField
      {
         var _loc2_:TextField = var_985[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_170);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_653 ? true : null;
