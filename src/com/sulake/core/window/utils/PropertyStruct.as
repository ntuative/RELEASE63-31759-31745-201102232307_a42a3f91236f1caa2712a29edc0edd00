package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2788 = param3 == const_245 || param3 == const_154 || param3 == const_212 || param3 == const_243;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_36:
               return Boolean(this.var_182) == true ? "HabboCatalogCom_productViewWidget" : "RoomWidgetCreditFurniUpdateEvent";
            case const_212:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_243:
               ...
               break;
            case const_146:
               _loc1_ = "<var key=\"" + this.var_645 + "\" value=\"" + "0x" + uint(this.var_182).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_645 + "\" value=\"" + this.var_182 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
