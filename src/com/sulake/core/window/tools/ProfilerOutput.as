package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1440:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1439:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_160:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2779 = new Array();
         this.var_160 = this.profiler;
         this._windowManager = param2;
         this.var_891 = param3;
         var _loc4_:ByteArray = new var_1440() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_160)
         {
            this.var_160.removeStopEventListener(this.refresh);
            this.var_160 = null;
         }
         if(!this.var_160 && param1)
         {
            this.var_160 = param1;
            this.var_160.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_783)
            {
               this.var_1860 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_160.getProfilerAgentsInArray();
         ...
         if(this.var_1860)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_160.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_160.numBitmapAssetInstances + " / " + this.var_160.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_891.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_160.numTrackedBitmapDataInstances + " / " + this.var_160.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1439() as ByteArray;
