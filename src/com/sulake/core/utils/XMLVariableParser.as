package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_223:String = "uint";
      
      public static const const_252:String = "Number";
      
      public static const const_1611:String = "float";
      
      public static const const_36:String = "Boolean";
      
      public static const const_1489:String = "bool";
      ...
      private static const const_592:String = "key";
      
      private static const const_932:String = "type";
      
      private static const const_591:String = "value";
      
      private static const const_604:String = "HabboCatalogCom_productViewWidget";
      
      private static const const_1700:String = "RoomWidgetCreditFurniUpdateEvent";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_592));
         }
         else
         {
            _loc4_ = param1.child(const_592)[0];
         }
         _loc7_ = param1.attribute(const_932);
         if(_loc7_.length() > 0)
         {
            _loc5_ = String(param1.attribute(const_932));
         }
         ...
         else
         {
            ...
            else if(_loc5_ == const_245 || _loc5_ == const_154)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1611:
               return Number(param1);
            case const_36:
               return param1 == const_604 || int(param1) > 0;
            case const_1489:
               return param1 == const_604 || int(param1) > 0;
            case const_146:
               return uint(param1);
            case const_154:
               return param1.split(const_1292);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_243:
               ...
               _loc5_.width = Number(param1.attribute(const_1290));
               _loc5_.height = Number(param1.attribute(const_1291));
               return _loc5_;
            case const_154:
               _loc3_ = new Map();
